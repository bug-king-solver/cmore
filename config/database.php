    ...
    */
    ...
    'connections' => [
        ...
        'mongodb' => [
            ...
            'database' => env('DB_MONGO_DATABASE', 'central'),
            'username' => env('DB_MONGO_USERNAME', 'root'),
            'password' => env('DB_MONGO_PASSWORD', 'root'),
            'options'  => [
                'database' => '',
                'tls' => env('DB_MONGO_TLS', true),
                'tlsCAFile' => env('DB_MONGO_CA_FILE', ''),
            ],
        ],
    ...
    */
    ...
    'redis' => [
        ...
        'options' => [
            ...
            'context' => ! env('REDIS_CONTEXT', true)
                ? []
                : [
                    'stream' => [
                        'cafile' => env('REDIS_CA_FILE', null),
