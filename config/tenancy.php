...
return [
    ...
    'bootstrappers' => [
        ...
        App\TenancyBootstrappers\FilesystemTenancyBootstrapper::class,
    ...
    'filesystem' => [
         ...
         *
         * Note: Disabling this will likely break local disk tenancy.
         * Only disable this if you're using an external file storage service like S3.
         *
    ...
    'features' => [
        ...
        // https://tenancy.samuelstancl.me/docs/v2/features/tenant-config/
        Stancl\Tenancy\Features\CrossDomainRedirect::class,
        // https://tenancy.samuelstancl.me/docs/v2/features/tenant-redirect/
    ],
    ...
    /**
     * Views tenancy config.
     */
    'views' => [
        // Each tenant view folder will be prepended by this prefix_base, followed by the tenant id.
        'prefix_base' => 'tenants.tenant',
    ],
];
