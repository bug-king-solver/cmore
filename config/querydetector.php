...
return [
     ...
     */
    'except' => [
        App\Models\Tenant\Question::class => [
            'parent',
        ],
        ...
        App\Models\User::class => [
            Spatie\Comments\Models\CommentNotificationSubscription::class,
        ],
        App\Models\Tenant\Answer::class => [
            Spatie\Comments\Models\Comment::class,
            App\Models\Tenant\Questionnaire::class,
        ],
    ],
