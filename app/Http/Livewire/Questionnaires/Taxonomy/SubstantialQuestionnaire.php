...
class SubstantialQuestionnaire extends Component
{
    ...
    public string $questionnaireColumn = 'contribute';
    public string $redirectRoute = 'substantial';
    ...
    public function mount($questionnaire, $code, $objective)
    {
        ...
        $this->eligibleText = __('Verified substantial contribution');
        $this->notEligibleText = __('Not verified substantial contribution');
    ...
    public function render(): View
    {
        ...
        return view('livewire.tenant.taxonomy.form.questions', ['backRoute' => 'tenant.taxonomy.substantial']);
    }
    ...
    {
        $this->confirmResetQuestions();

        return redirect()->route('tenant.taxonomy.substantial', [
