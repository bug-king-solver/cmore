 ...
 * )
 */
class EmotionsDailyRequest extends BaseFormRequest
{
    /** @OA\Property(property="ainfo_id", format="integer", type="integer" , description="Analysis info id", example=1 )  */
    public int $ainfo_id;

    /** @OA\Property(property="data", format="json", type="json" , description="Data json", example={"n_tweets":0.7,"anger_count":0.1,"anger_percent":0.7,"disgust_count":0.6,"disgust_percent":0.8,"fear_count":0.7,"fear_percent":0.9,"joy_count":0.8,"joy_percent":0.9,"neutral_count":1,"neutral_percent":0.2,"sadness_count":0.7,"sadness_percent":0.7,"surprise_count":0.1,"surprise_percent":0.8} )  */
    public string $data;
