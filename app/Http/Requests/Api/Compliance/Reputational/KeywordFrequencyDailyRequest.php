...
/**
 * @OA\Schema(
 *   @OA\Xml(name="keywordFrequencyDaily")
 * )
 * @OA\Parameter(
 *   name="keywordFrequencyDaily",
 *   in="path",
 *   description="id",
 *   required=true,
 ...
 * )
 */
class KeywordFrequencyDailyRequest extends BaseFormRequest
{
    /** @OA\Property(property="ainfo_id", format="integer", type="integer" , description="Analysis info id", example=1 )  */
    public int $ainfo_id;

    /** @OA\Property(property="data", format="json", type="json" , description="Data json", example={"kw_weights":{"burger":100,"burger king":69,"fuck burger king":65}} )  */
    public string $data;
