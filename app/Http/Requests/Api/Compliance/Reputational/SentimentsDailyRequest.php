...
/**
 * @OA\Schema(
 *   @OA\Xml(name="sentimentsDaily")
 * )
 * @OA\Parameter(
 *   name="sentimentsDaily",
 *   in="path",
 *   description="id",
 *   required=true,
 ...
 * )
 */
class SentimentsDailyRequest extends BaseFormRequest
{
    /** @OA\Property(property="ainfo_id", format="integer", type="integer" , description="Analysis info id", example=1 )  */
    public int $ainfo_id;

    /** @OA\Property(property="data", format="json", type="json" , description="Data json", example={"positive_count": 30, "negative_count": 20, "neutral_count": 50} )  */
    public string $data;
