...
class Initiative extends CustomResource
{
    /**
     ...
     * @var string
     */
    public static $model = \App\Models\Tenant\Initiative::class;
        ...
        return [
            ...
            Translatable::make([
                Text::make(
                    __('Name'),
                    'name',
                    fn () => mb_strlen($this->name) <= 60 ? $this->name : mb_substr($this->name, 0, 60) . '...'
                )->onlyOnIndex(),
                Text::make(__('Name'), 'name')->hideFromIndex(),
            ]),
