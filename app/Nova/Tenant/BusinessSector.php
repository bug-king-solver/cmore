...
class BusinessSector extends CustomResource
{
    /**
     ...
     * @var string
     */
    public static $model = \App\Models\Tenant\BusinessSector::class;
    ...
    public function fields(NovaRequest $request)
    {
        return [
            ...
            HasMany::make(__('Companies'), 'companies', Company::class),
