...
resource "ibm_cis_domain" "dev-cmore-com" {
    cis_id = ibm_cis.internet-services.id
    domain                = "dev-cmore.com"
    type                  = "full"
...
resource "ibm_cis_tls_settings" "tls_settings" {
    cis_id = ibm_cis.internet-services.id
    domain_id = ibm_cis_domain.dev-cmore-com.domain_id
    min_tls_version = "1.3"
    tls_1_3 = "on"
    universal_ssl = true
...
resource "ibm_cis_edge_functions_trigger" "dev-cmore-com" {
    action_name             = ibm_cis_edge_functions_action.app-dev.action_name
    cis_id                  = ibm_cis.internet-services.id
    domain_id               = ibm_cis_domain.dev-cmore-com.domain_id
    pattern_url             = "dev-cmore.com/*"
...
# *.dev-cmore.com
resource "ibm_cis_edge_functions_trigger" "wildcard-dev-cmore-com" {
    action_name             = ibm_cis_edge_functions_action.app-dev.action_name
    cis_id                  = ibm_cis.internet-services.id
    domain_id               = ibm_cis_domain.dev-cmore-com.domain_id
    pattern_url             = "*.dev-cmore.com/*"
...
resource "ibm_cis_edge_functions_action" "app-dev" {
    action_name = "app"
    cis_id      = ibm_cis.internet-services.id
    domain_id   = ibm_cis_domain.dev-cmore-com.domain_id
    script      = <<-EOT
