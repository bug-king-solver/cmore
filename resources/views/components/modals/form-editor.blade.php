...
<div class="mt-4 {{ $form_div_size }} ">
    ...
    <div class="bg-white" wire:ignore data-test="{{ $dataTest }}">
        ...
        <div wire:model.defer="{{ $id }}" class="h-64 min-h-[150px]" x-data
            x-ref="quillEditor_{{ $id }}" x-init="quill = new Quill($refs.quillEditor_{{ $id }}, {
                theme: 'snow',
            ...
            x-on:quill-input.debounce.500ms="@this.set('{{ $id }}', $event.detail)">
