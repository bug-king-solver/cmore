...
<body class="bg-esg4 h-screen antialiased overflow-x-hidden">
    ...
    <div class="flex justify-center items-center h-screen">
        <div class="info w-auto">
            <div class="m-auto content-center w-[656px]">
                @include('icons.errors.500')
            </div>
            <div class="text-center content mt-8 max-w-2xl">
                <h3 class="font-bold text-3xl text-esg6">{!! __('Internal Server Error') !!}</h3>
                <p class="text-2xl text-esg8 mb-8">
                    {!! __(
                        'Internal Server Error 500. We apologize for the inconvenience and are actively working to resolve the issue.<br>Please try again in a few minutes.',
                    ) !!}
                </p>
