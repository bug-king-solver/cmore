<div>
    <h3 class="text-base font-medium text-esg29">{{ __('Upcoming payment') }}</h3>
    <div class="text-esg29 mt-2 text-sm font-medium overflow-hidden shadow sm:rounded-md">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex flex-shrink-0">
                        <div class="ml-2 flex flex-shrink-0 items-center">
                            ...
                            <span class="ml-2 inline-flex rounded-full bg-indigo-100 px-2 text-xs font-semibold leading-5 text-indigo-800">
                ...
                <div class="mt-2 sm:flex sm:justify-between">
                    <div class="sm:flex">
                        <div class="mr-6 flex items-center text-sm leading-5 text-gray-500">
                            <svg class="h-5 w-5 flex-shrink-0 text-gray-400" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg>
                            <div class="ml-1">
                                {{ $invoice->total() }}
                            </div>
                        </div>
        ...
        <p class="p-4 text-sm font-medium text-esg29">
            {{ __('You\'re not subscribed yet. Please select a plan below.') }}
        </p>
        @endif
    </div>
</div>
