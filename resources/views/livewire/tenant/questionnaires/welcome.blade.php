            ...
            <div class="px-4 md:px-8">
                <div class="mt-16">
                    ...
                    <p class="text-esg8 text-lg text-center">
                        {{ __('You can use the left navigation menu to choose a category or subcategory to start.') }}
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10 mt-8">
                    ...
                    <div class="flex gap-5">
                        ...
                        <div class="">
                            ...
                            <p class="text-base text-esg16">
                                {{ __('Users can be assigned to respond the questions and to validate the answers') }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-5">
                        ...
                        <div class="">
                            ...
                            <p class="text-base text-esg16">
                                {{ __('You can communicate with other users on each question') }} </p>
                        </div>
                    </div>
                </div>
