                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm font-medium text-orange-800">
                            {{ __('You\'re on trial until') }} <time datetime="{{ tenant()->trial_ends_at->format('Y-m-d') }}">
                            {{ tenant()->trial_ends_at->format('M d, Y') }}</time>, <strong>{{ __('but you haven\'t subscribed to any plan yet') }}</strong>{{ __('. Please do so now to contine using the application even after your trial ends.') }}
                        </p>
                    </div>
                </div>
            </div>
        ...
        {{-- No subscription --}}
            <div class="rounded-md bg-orange-50 p-4">
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm font-medium text-orange-800">
                            {{ __('You\'re on :strong not subscribed:cstrong. If you wish to keep using the application, please choose a subscription plan below.', ['strong' => '<strong>', 'cstrong' => '</strong>']) }}
                        </p>
                    </div>
                </div>
            </div>
