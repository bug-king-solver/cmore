<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="{{ $class ?? '' }}" id="flag-icons-ky" version="1.1" viewBox="0 0 640 480">
  ...
  <g id="border" stroke="#fff" stroke-linejoin="round" stroke-width="9.6" transform="translate(-306.8 -21.2) scale(.87136)">
    <use xlink:href="#shield" class="{{ $class ?? '' }}" id="use1093" width="100%" height="100%" x="0" y="0"/>
    <use xlink:href="#motto1" class="{{ $class ?? '' }}" id="use1095" width="100%" height="100%" x="0" y="0"/>
    <use xlink:href="#motto2" class="{{ $class ?? '' }}" id="use1097" width="100%" height="100%" x="0" y="0"/>
    <use xlink:href="#rope" class="{{ $class ?? '' }}" id="use1099" width="100%" height="100%" x="0" y="0"/>
    <use xlink:href="#turtle" class="{{ $class ?? '' }}" id="use1101" width="100%" height="100%" x="0" y="0"/>
    <use xlink:href="#pineapple1" class="{{ $class ?? '' }}" id="use1103" width="100%" height="100%" x="0" y="0"/>
    <use xlink:href="#pineapple2" class="{{ $class ?? '' }}" id="use1105" width="100%" height="100%" x="0" y="0"/>
  </g>
  ...
  <g id="g1475" stroke="none" style="stroke-width:1.4" transform="translate(-306.8 -21.2) scale(.87136)">
    ...
    <use xlink:href="#star" class="{{ $class ?? '' }}" id="use1469" width="100%" height="100%" x="90.1" y="0"/>
    <use xlink:href="#star" class="{{ $class ?? '' }}" id="use1471" width="100%" height="100%" x="45" y="52.2"/>
