<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="{{ $class ?? '' }}" id="flag-icons-gb-nir" viewBox="0 0 640 480">
  ...
  <use xlink:href="#a" class="{{ $class ?? '' }}" id="use6706" width="600" height="300" transform="matrix(0 .75 -1 0 560 0)"/>
