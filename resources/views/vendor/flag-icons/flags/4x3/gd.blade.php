<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="{{ $class ?? '' }}" id="flag-icons-gd" viewBox="0 0 640 480">
  <defs>
    <g id="c">
      <g id="b">
  ...
  <use xlink:href="#c" class="{{ $class ?? '' }}" id="d" width="100%" height="100%" transform="matrix(31.2 0 0 31.2 320 33.6)"/>
  <use xlink:href="#d" width="100%" height="100%" x="100" transform="translate(30.3)"/>
