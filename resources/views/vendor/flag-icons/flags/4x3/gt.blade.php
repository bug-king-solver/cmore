<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="{{ $class ?? '' }}" id="flag-icons-gt" viewBox="0 0 640 480">
  <defs>
    <radialGradient id="a">
      <stop offset=".2" stop-color="#f9f0aa"/>
      <stop offset="1" stop-color="#b07e09"/>
    </radialGradient>
    <radialGradient xlink:href="#a" class="{{ $class ?? '' }}" id="d" cx="447.4" cy="308.3" r="16.5" gradientUnits="userSpaceOnUse"/>
    <radialGradient xlink:href="#a" class="{{ $class ?? '' }}" id="e" cx="451.6" cy="313" r="10.9" gradientUnits="userSpaceOnUse"/>
    <radialGradient xlink:href="#a" class="{{ $class ?? '' }}" id="f" cx="454.1" cy="308.6" r="9.8" gradientUnits="userSpaceOnUse"/>
    <radialGradient xlink:href="#a" class="{{ $class ?? '' }}" id="g" cx="458.4" cy="307.1" r="17.4" gradientUnits="userSpaceOnUse"/>
    <radialGradient xlink:href="#a" class="{{ $class ?? '' }}" id="j" cx="446" cy="252.4" r="13" gradientUnits="userSpaceOnUse"/>
