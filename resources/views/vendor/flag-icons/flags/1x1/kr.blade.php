<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="{{ $class ?? '' }}" id="flag-icons-kr" viewBox="0 0 512 512">
  <defs id="defs87">
    <clipPath id="kr-a">
  ...
  <g id="g540" style="fill-rule:evenodd" transform="rotate(-56.3 367.2 -111.2) scale(9.375)">
    <g id="b2">
      ...
      <use xlink:href="#b" class="{{ $class ?? '' }}" id="use529" width="100%" height="100%" x="0" y="44"/>
    </g>
  ...
  <g id="g546" style="fill-rule:evenodd" transform="rotate(-123.7 196.5 59.5) scale(9.375)">
    <use xlink:href="#b2" class="{{ $class ?? '' }}" id="use542" width="100%" height="100%" x="0" y="0"/>
