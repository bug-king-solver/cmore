<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="{{ $class ?? '' }}" id="flag-icons-ni" viewBox="0 0 512 512">
  <defs>
    ...
    <linearGradient xlink:href="#a" class="{{ $class ?? '' }}" id="h" x1="444.5" x2="634.4" y1="317.5" y2="317.5" gradientUnits="userSpaceOnUse"/>
    <linearGradient xlink:href="#b" class="{{ $class ?? '' }}" id="v" x1="484.8" x2="484.8" y1="311.7" y2="317.6" gradientUnits="userSpaceOnUse"/>
    <linearGradient xlink:href="#a" class="{{ $class ?? '' }}" id="o" x1="444.5" x2="634.4" y1="317.5" y2="317.5" gradientUnits="userSpaceOnUse"/>
    <linearGradient xlink:href="#a" class="{{ $class ?? '' }}" id="p" x1="444.5" x2="634.4" y1="317.5" y2="317.5" gradientUnits="userSpaceOnUse"/>
    <linearGradient xlink:href="#a" class="{{ $class ?? '' }}" id="q" x1="444.5" x2="634.4" y1="317.5" y2="317.5" gradientUnits="userSpaceOnUse"/>
    <linearGradient xlink:href="#a" class="{{ $class ?? '' }}" id="r" x1="444.5" x2="634.4" y1="317.5" y2="317.5" gradientUnits="userSpaceOnUse"/>
    <linearGradient xlink:href="#b" class="{{ $class ?? '' }}" id="u" x1="484.8" x2="484.8" y1="311.7" y2="317.6" gradientUnits="userSpaceOnUse"/>
    <linearGradient xlink:href="#a" class="{{ $class ?? '' }}" id="x" x1="98.9" x2="125" y1="1440.2" y2="1440.2" gradientTransform="scale(4.45715 .22436)" gradientUnits="userSpaceOnUse"/>
    <linearGradient xlink:href="#a" class="{{ $class ?? '' }}" id="j" x1="444.5" x2="634.4" y1="317.5" y2="317.5" gradientUnits="userSpaceOnUse"/>
    <linearGradient xlink:href="#a" class="{{ $class ?? '' }}" id="l" x1="444.5" x2="634.4" y1="317.5" y2="317.5" gradientUnits="userSpaceOnUse"/>
    <linearGradient xlink:href="#a" class="{{ $class ?? '' }}" id="m" x1="444.5" x2="634.4" y1="317.5" y2="317.5" gradientUnits="userSpaceOnUse"/>
    <linearGradient xlink:href="#a" class="{{ $class ?? '' }}" id="i" x1="444.5" x2="634.4" y1="317.5" y2="317.5" gradientUnits="userSpaceOnUse"/>
    <linearGradient xlink:href="#b" class="{{ $class ?? '' }}" id="s" x1="484.8" x2="484.8" y1="311.7" y2="317.6" gradientUnits="userSpaceOnUse"/>
    <linearGradient xlink:href="#a" class="{{ $class ?? '' }}" id="y" x1="47.9" x2="61.7" y1="3054.2" y2="3054.2" gradientTransform="scale(9.12405 .1096)" gradientUnits="userSpaceOnUse"/>
    <clipPath id="ni-c">
