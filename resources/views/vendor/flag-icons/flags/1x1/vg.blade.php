<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="{{ $class ?? '' }}" id="flag-icons-vg" viewBox="0 0 512 512">
  <defs id="defs4389">
    <linearGradient id="a">
      <stop id="stop4369" offset="0" stop-color="red"/>
      <stop id="stop4371" offset="1" stop-color="#ff0"/>
    </linearGradient>
    <linearGradient xlink:href="#a" class="{{ $class ?? '' }}" id="c" x1="103.1" x2="92.5" y1="111.3" y2="107.8" gradientTransform="matrix(.85005 0 0 1.92216 191.3 180)" gradientUnits="userSpaceOnUse"/>
    <linearGradient xlink:href="#a" class="{{ $class ?? '' }}" id="d" x1="103.1" x2="92.5" y1="111.3" y2="107.8" gradientTransform="matrix(.85005 0 0 1.92216 190.6 143.9)" gradientUnits="userSpaceOnUse"/>
    <linearGradient xlink:href="#a" class="{{ $class ?? '' }}" id="e" x1="103.1" x2="92.5" y1="111.3" y2="107.8" gradientTransform="matrix(.85005 0 0 1.92216 317.4 111.1)" gradientUnits="userSpaceOnUse"/>
    <linearGradient xlink:href="#a" class="{{ $class ?? '' }}" id="f" x1="103.1" x2="92.5" y1="111.3" y2="107.8" gradientTransform="matrix(.85005 0 0 1.92216 193.6 76.1)" gradientUnits="userSpaceOnUse"/>
    <linearGradient xlink:href="#a" class="{{ $class ?? '' }}" id="g" x1="103.1" x2="92.5" y1="111.3" y2="107.8" gradientTransform="matrix(.85005 0 0 1.92216 194 41.7)" gradientUnits="userSpaceOnUse"/>
    <linearGradient xlink:href="#a" class="{{ $class ?? '' }}" id="h" x1="103.1" x2="92.5" y1="111.3" y2="107.8" gradientTransform="matrix(.85005 0 0 1.92216 194.6 6.6)" gradientUnits="userSpaceOnUse"/>
    <linearGradient xlink:href="#a" class="{{ $class ?? '' }}" id="i" x1="103.1" x2="92.5" y1="111.3" y2="107.8" gradientTransform="matrix(.85005 0 0 1.92216 318.4 7.2)" gradientUnits="userSpaceOnUse"/>
    <linearGradient xlink:href="#a" class="{{ $class ?? '' }}" id="j" x1="103.1" x2="92.5" y1="111.3" y2="107.8" gradientTransform="matrix(.85005 0 0 1.92216 317.2 41.6)" gradientUnits="userSpaceOnUse"/>
    <linearGradient xlink:href="#a" class="{{ $class ?? '' }}" id="k" x1="103.1" x2="92.5" y1="111.3" y2="107.8" gradientTransform="matrix(.85005 0 0 1.92216 315.7 76.7)" gradientUnits="userSpaceOnUse"/>
    <linearGradient xlink:href="#a" class="{{ $class ?? '' }}" id="m" x1="103.1" x2="92.5" y1="111.3" y2="107.8" gradientTransform="matrix(.85005 0 0 1.92216 317.1 145.7)" gradientUnits="userSpaceOnUse"/>
    <linearGradient xlink:href="#a" class="{{ $class ?? '' }}" id="n" x1="103.1" x2="92.5" y1="111.3" y2="107.8" gradientTransform="matrix(.85005 0 0 1.92216 216.3 113.3)" gradientUnits="userSpaceOnUse"/>
    <linearGradient xlink:href="#a" class="{{ $class ?? '' }}" id="l" x1="103.1" x2="92.5" y1="111.3" y2="107.8" gradientTransform="matrix(.85004 0 0 1.9222 317.3 180.4)" gradientUnits="userSpaceOnUse"/>
  ...
  <g id="g1028" transform="translate(-282.6 18.3) scale(.73883)">
    ...
    <use xlink:href="#lamp" class="{{ $class ?? '' }}" id="use874" width="100%" height="100%" x="-.8" y="41.3"/>
    <use xlink:href="#lamp" class="{{ $class ?? '' }}" id="use876" width="100%" height="100%" x="-1.1" y="82"/>
    <use xlink:href="#lamp" class="{{ $class ?? '' }}" id="use878" width="100%" height="100%" x="25.6" y="126.1"/>
    <use xlink:href="#lamp" class="{{ $class ?? '' }}" id="use880" width="100%" height="100%" x="-4.6" y="162.2"/>
    <use xlink:href="#lamp" class="{{ $class ?? '' }}" id="use882" width="100%" height="100%" x="-3.8" y="204.8"/>
    <use xlink:href="#lamp" class="{{ $class ?? '' }}" id="use884" width="100%" height="100%" x="146.3" y=".7"/>
    <use xlink:href="#lamp" class="{{ $class ?? '' }}" id="use886" width="100%" height="100%" x="144.9" y="41.2"/>
    <use xlink:href="#lamp" class="{{ $class ?? '' }}" id="use888" width="100%" height="100%" x="143.1" y="82.7"/>
    <use xlink:href="#lamp" class="{{ $class ?? '' }}" id="use890" width="100%" height="100%" x="145.2" y="123.4"/>
    <use xlink:href="#lamp" class="{{ $class ?? '' }}" id="use892" width="100%" height="100%" x="144.7" y="164.2"/>
    <use xlink:href="#lamp" class="{{ $class ?? '' }}" id="use894" width="100%" height="100%" x="144.9" y="205.2"/>
