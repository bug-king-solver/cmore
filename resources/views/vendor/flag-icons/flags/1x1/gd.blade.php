<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="{{ $class ?? '' }}" id="flag-icons-gd" viewBox="0 0 512 512">
  <defs>
    <g id="c">
      <g id="b">
  ...
  <use xlink:href="#c" class="{{ $class ?? '' }}" id="d" width="100%" height="100%" transform="translate(256 35.9) scale(33.28)"/>
