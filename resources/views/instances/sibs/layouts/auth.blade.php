...
<body class="bg-esg4 h-screen antialiased">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2">
        <div id="login"
            class="w-full h-screen bg-fixed grid grid-rows-1 self-stretch place-content-center order-0 left-4 items-center bg-[url('/images/pages/bg-login-2.png')] bg-fixed bg-no-repeat bg-cover before:bg-esg6/[0.75] before:absolute before:w-full before:md:w-1/2 before:h-full">
            ...
            <main class="flex flex-col justify-around items-center pb-0 pl-[32px] pr-[32px] h-full w-full">
                ...
                <div>
                    <div class="absolute bottom-0 left-6 pb-[24px]">
                        <span class="font-encodesans leading-5 text-sm font-normal text-esg11">© ESG Maturity
                            2022</span>
                    </div>
