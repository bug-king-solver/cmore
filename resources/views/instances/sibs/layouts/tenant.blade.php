...
<body class="bg-esg4 h-screen antialiased overflow-x-hidden" x-data="{ trial_modal: false, {!! $xData ?? '' !!} }" {!! $bodyTag ?? '' !!}>
    ...
    <div x-cloak x-show="trial_modal">
        <div class="fixed inset-x-0 bottom-0 z-50 px-4 pb-4 sm:inset-0 sm:flex sm:items-center sm:justify-center">
            ...
            <div @click.away="trial_modal = false"
                class="bg-esg4 border-esg6 w-[40rem] transform overflow-hidden rounded-lg border-2 shadow-xl">
    ...
    <div id="app">
        ...
        <nav class="bg-esg4 fixed top-0 z-50 h-16 w-full print:hidden drop-shadow @if (tenant()->show_topbar) left-0 top-10 @endif"
                        ...
                        <div class="flex items-center md:ml-6">
                            @guest
                                <a href="{{ route('tenant.login') }}"
                                    class="hover:text-esg27 focus:text-esg27 mt-1 block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 focus:bg-gray-700 focus:outline-none">{{ __('Login') }}</a>
                                @if (Route::has('tenant.register'))
                                    <a href="{{ route('tenant.register') }}"
                                        class="hover:text-esg27 focus:text-esg27 mt-1 block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 focus:bg-gray-700 focus:outline-none">{{ __('Register') }}</a>
                                @endif
                            @else
                                <div class="flex hidden gap-x-10 md:block md:flex">
                                    ...
                                    @if (tenant()->hasBenchmarkingFeature || tenant()->hasComplianceFeature || tenant()->hasReputationFeature)
                                        <div x-data="{ expanded: false }"
                                            class="relative z-10 inline cursor-pointer text-sm font-medium uppercase">
                                            <a @click="expanded = !expanded" @click.away="expanded = false"
                                                ...
                                                <div x-cloak x-show="expanded"
                                                    ...
                                                    <div
                                                        ...
                                                        <a href="{{ route('tenant.garbtar.index') }}"
                                                            ...
                                                            data-test="panel-menu">{{ __('Panel') }}</a>
                                            ...
                                            <div x-cloak x-show="expanded"
                                                ...
                                                <div class="bg-esg4 shadow-xs rounded py-1 w-max shadow-bxesg1">
                                                    ...
                                                    @if (tenant()->hasMonitoringFeature)
                                                        @can('data.view')
                                                            <a href="{{ route('tenant.data.index') }}"
        ...
        @if (isset($isheader))
            <div class="bg-esg6 block h-48 pt-28 pl-10 text-esg27 text-3xl font-medium print:hidden">
                <div class="mx-auto max-w-7xl px-2 text-esg27 text-2xl font-bold">
                    {{ $title }}
                </div>
            </div>
        @endif
