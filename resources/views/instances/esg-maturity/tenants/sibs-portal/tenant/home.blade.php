...
@section('content')
        ...
        <div
            ...
            <div class="w-full mx-auto max-w-7xl pt-8 px-4 sm:px-6 lg:px-8 absolute z-90">
                <div class="text-center">
                    ...
                    <p class="text-2xl text-esg8 mt-4">
                        {{ __('An environment where companies can submit or update their sustainability data with acceding banks') }}
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="my-32 md:ml-12 enter-transition">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-9">
            <div class="mt-6">
                ...
                <p class="text-4xl font-bold text-black mt-4 leading-10">
                    {!! __('We :stylesimplify:closestyle the sustainability', [
                        'style' => '<span class="bg-esg5 text-esg4 mr-2 px-2">',
                        'closestyle' => '</span>',
                    ]) !!}
                </p>
    ...
    <div class="enter-transition">
        ...
        <div class="grid justify-items-center mt-16">
            <x-buttons.btn text="{{ __('Start your journey now') }}"
                @click="window.location.href = '{{ route('tenant.companies.form') }}'" class="!p-3 !uppercase" />
        </div>
    </div>
@endsection
