    ...
    <div class="px-4 lg:px-0" x-data="{ main: false, environment: true, social: true, governance: true }">
        ...
        <div class="">
            <div class="max-w-2xl mx-auto mt-10 text-center">
                ...
                <p class="mt-4 text-lg text-esg16">
                    {{ __('This is the data visualization of the answers given on the questionnaire.
                                                                                    Select or unselect the sections below to control what is being showed.') }}
                </p>
            </div>
            ...
            <div class="my-8 grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <div
                    class="grid place-content-center border border-esg2 rounded-md bg-esg2/10  place-content-center shadow">
                    <div class="flex items-center">
                        <input id="Environment" type="checkbox" checked value="" name="Environment"
                            class="w-4 h-4 text-esg2 bg-esg4 border-esg2 rounded" x-on:click="environment = ! environment">
                        <label for="Environment"
                            class="w-full py-4 ml-2 text-base font-medium text-esg2">{{ __('Environment') }}</label>
                    </div>
                </div>

                <div
                    class="grid place-content-center border border-esg1 rounded-md bg-esg1/10  place-content-center shadow">
                    <div class="flex items-center">
                        <input id="Social" type="checkbox" value="" checked name="Social"
                            class="w-4 h-4 text-esg1 bg-esg4 border-esg1 rounded" x-on:click="social = ! social">
                        <label for="Social"
                            class="w-full py-4 ml-2 text-base font-medium text-esg1">{{ __('Social') }}</label>
                    </div>
                </div>

                <div
                    class="grid place-content-center border border-esg3 rounded-md bg-esg3/10  place-content-center shadow">
                    <div class="flex items-center ">
                        <input id="Governance" type="checkbox" value="" checked name="Governance"
                            class="w-4 h-4 text-esg3 bg-esg4 border-esg3 rounded" x-on:click="governance = ! governance">
                        <label for="Governance"
                            class="w-full py-4 ml-2 text-base font-medium text-esg3">{{ __('Governance') }}</label>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-10 pagebreak print:mt-20" x-show="environment">
                <div class="px-8 bg-esg2/10 rounded-3xl py-8">
                    <div class="border-b border-esg2">
                        <span class="font-encodesans text-xl leading-10 text-esg8 uppercase">
                            {{ __('Environment') }}</span>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mt-10 print:-mt-10 nonavoid">
                        ...
                        {{-- NEW --}}
                        @php
                            $subpoint = json_encode([['color' => 'bg-[#008131]', 'text' => __('Baseline year: 2019')], ['color' => 'bg-[#99CA3C]', 'text' => __('Reporting period: 2020')]]);

                            $subinfo = json_encode([['value' => '1.264.13', 'unit' => 'm3']]);
                        @endphp
                        <x-cards.card-dashboard-version1-withshadow
                            text="{{ json_encode([__('Atmospheric Pollutants')]) }}" subpoint="{{ $subpoint }}"
                            class="!h-min">
                            <x-charts.bar id="atmospheric_pollutants" class="m-auto relative !h-full !w-full" unit="kg"
                                subinfo="{{ $subinfo }}" />
                        </x-cards.card-dashboard-version1-withshadow>
                        ...
                        @endphp
                        <x-cards.card-dashboard-version1-withshadow
                            text="{{ json_encode([__('Ozone layer depleting substances')]) }}"
                            subpoint="{{ $subpoint }}" class="!h-min">
                            <x-charts.bar id="ozone_layer" class="m-auto relative !h-full !w-full" unit="kg"
                                subinfo="{{ $subinfo }}" />
                        </x-cards.card-dashboard-version1-withshadow>
                        ...
                        @php
                            ...
                            $subinfo = json_encode([['value' => '1.539.30', 'unit' => 't CO2 eq', 'color' => 'text-[#008131]'], ['value' => '1.200', 'unit' => 't CO2 eq', 'color' => 'text-[#99CA3C]']]);
                        @endphp
                        <x-cards.card-dashboard-version1-withshadow
                            text="{{ json_encode([__('GHG emissions by category')]) }}" subpoint="{{ $subpoint }}"
                            class="!h-min">
                            <x-charts.bar id="co2_emissions" class="m-auto relative !h-full !w-full" unit="t CO2 eq"
                                subinfo="{{ $subinfo }}" />
                        </x-cards.card-dashboard-version1-withshadow>
                        ...
                        <x-cards.card-dashboard-version1-withshadow text="{{ json_encode([__('energy consumption')]) }}"
                            type="none" class="!h-auto" subpoint="{{ $subpoint }}" contentplacement="none">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="text-center  w-full">
                                    <label class="text-xs font-medium text-esg8"> {{ __('Reporting period: 2020') }}
                                    </label>
                                ...
                                <div class="">
                                    <label for="checkbox-website"
                                        class="font-encodesans text-4xl font-medium text-esg8">1.234 <span
                                            class="text-base text-esg8">t CO2 eq / €</span></label>
                                </div>
                        ...
                        <x-cards.card-dashboard-version1-withshadow text="{{ json_encode([__('Energy intensity')]) }}"
                            ...
                            <div class="flex items-center justify-between w-full">
                                <div class="">
                                    <label for="checkbox-website"
                                        class="font-encodesans text-4xl font-medium text-esg8">1.234 <span
                                            class="text-base text-esg8">MWh / €</span></label>
                                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mt-5">
                        <div>
                            <x-cards.card-dashboard-version1-withshadow text="{{ json_encode([__('Waste produced')]) }}"
                                ...
                                <x-charts.donut id="waste_produced" class="m-auto !h-[180px] !w-[180px]"
                                    legendes="true" />
                            </x-cards.card-dashboard-version1-withshadow>
                        </div>

                        <div class="grid grid-cols-1 gap-5">
                            <x-cards.card-dashboard-version1-withshadow text="{{ json_encode([__('Recycled waste')]) }}"
                                class="!h-full" contentplacement="none">
                                <div class="flex items-center justify-between w-full">
                                    <div class="">
                                        <label for="checkbox-website"
                                            class="font-encodesans text-4xl font-medium text-esg8">20 <span
                                                class="text-base text-esg8">t</span></label>
                                    </div>
                            ...
                            {{-- NEW --}}
                            <x-cards.card-dashboard-version1-withshadow
                                text="{{ json_encode([__('Waste sent for disposal')]) }}" class="!h-full"
                                contentplacement="none">
                                <div class="flex items-center justify-between w-full">
                                    <div class="">
                                        <label for="checkbox-website"
                                            class="font-encodesans text-4xl font-medium text-esg8">123.4 <span
                                                class="text-base text-esg8">t</span></label>
                                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mt-5 nonavoid">
                        ...
                        {{-- NEW --}}
                        <x-cards.card-dashboard-version1-withshadow text="{{ json_encode([__('radioactive waste')]) }}"
                            class="!h-full" contentplacement="none">
                            <div class="flex items-center justify-between w-full">
                                <div class="">
                                    <label for="checkbox-website"
                        ...
                        {{-- NEW --}}
                        <x-cards.card-dashboard-version1-withshadow text="{{ json_encode([__('water consumption')]) }}"
                            ...
                            <div class="flex items-center justify-between border-b border-b-esg7/40 w-full mt-10 pb-3">
                                <div class="">
                                    <p for="checkbox-website" class="font-encodesans text-sm font-normal text-esg8">
                                        {{ __('Located in an area(s) of high water stress') }}</p>
                                </div>
                                <div class="">
                            ...
                            <div class="flex items-center justify-between border-b border-b-esg7/40 mt-5 pb-3">
                                <div class="">
                                    <p for="checkbox-website" class="font-encodesans text-sm font-normal text-esg8">
                                        {{ __('Recycles and/or reuses water') }}</p>
                                </div>
                                <div class="">
                                    @include('icons.checkbox', ['color' => color(2)])
                                </div>
                            ...
                            <div class="flex items-center justify-between border-b border-b-esg7/40 mt-5 pb-3">
                                <div class="">
                                    <p for="checkbox-website" class="font-encodesans text-sm font-normal text-esg8">
                                        {{ __('Carries out direct discharges into the aquatic environment') }}</p>
                                </div>
                                <div class="">
                                    @include('icons.checkbox', ['color' => color(2)])
                                </div>
                            ...
                            <div class="flex items-center justify-between border-b border-b-esg7/40 w-full mt-5 pb-3">
                                <div class="">
                                    <p for="checkbox-website" class="font-encodesans text-sm font-normal text-esg8">
                                        {{ __('Has a wastewater discharge license') }}</p>
                                </div>
                                <div class="">
                                    @include('icons.checkbox', ['color' => color(2)])
                                </div>
                            ...
                            <div class="flex items-center justify-between border-b border-b-esg7/40 mt-5 pb-3">
                                <div class="">
                                    <p for="checkbox-website" class="font-encodesans text-sm font-normal text-esg8">
                                        {{ __('Monitors water discharge conditions (discharge values - physico-chemical parameters)') }}
                                    </p>
                                </div>
                                <div class="">
                                    @include('icons.checkbox', ['color' => color(2)])
                            ...
                            <div class="flex items-center justify-between border-b border-b-esg7/40 mt-5 pb-3">
                                <div class="">
                                    <p for="checkbox-website" class="font-encodesans text-sm font-normal text-esg8">
                                        {{ __('Cases of non-compliance with discharge limits') }}</p>
                                </div>
                                <div class="">
                                    @include('icons.checkbox', ['color' => color(2)])
                                </div>
                        ...
                        <x-cards.card-dashboard-version1-withshadow text="{{ json_encode([__('water consumed')]) }}"
                            subpoint="{{ $subpoint }}" class="!h-min">
                            <x-charts.bar id="water_consumed" class="m-auto relative !h-full !w-full" unit="m3"
                                subinfo="{{ $subinfo }}" />
                        </x-cards.card-dashboard-version1-withshadow>

                        {{-- NEW --}}
                        <x-cards.card-dashboard-version1-withshadow
                            text="{{ json_encode([__('Water recycled and/or reused')]) }}" class="!h-full"
                            contentplacement="none">
                            <div class="flex items-center justify-between w-full">
                                <div class="">
                                    <label for="checkbox-website"
                                        class="font-encodesans text-4xl font-medium text-esg8">123.4 <span
                                            class="text-base text-esg8">m3</span></label>
                                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mt-5 nonavoid">
                        <div class="grid grid-cols-1 gap-5">
                            {{-- NEW --}}
                            <x-cards.card-dashboard-version1-withshadow
                                text="{{ json_encode([__('Biodiversity Impact')]) }}" class="!h-auto" type="none"
                                contentplacement="none">
                                <div class="flex items-center justify-between border-b border-b-esg7/40 w-full mt-10 pb-3">
                                    <div class="">
                                        <p for="checkbox-website" class="font-encodesans text-sm font-normal text-esg8">
                                ...
                                <div class="flex items-center justify-between border-b border-b-esg7/40 mt-5 pb-3">
                                    <div class="">
                                        <p for="checkbox-website" class="font-encodesans text-sm font-normal text-esg8">
                                            {{ __('Operations in or near protected areas and/or areas rich in biodiversity') }}
                                        </p>
                                    </div>
                                    <div class="">
                                        @include('icons.checkbox', ['color' => color(2)])
                                ...
                                <div class="flex items-center justify-between border-b border-b-esg7/40 mt-5 pb-3">
                                    <div class="">
                                        <p for="checkbox-website" class="font-encodesans text-sm font-normal text-esg8">
                                            {{ __('Activities have a negative impact on a biodiversity') }}</p>
                                    </div>
                                    <div class="">
                                        @include('icons.checkbox', ['color' => color(2)])
                                    </div>
                                ...
                                <div class="flex items-center justify-between border-b border-b-esg7/40 w-full mt-5 pb-3">
                                    <div class="">
                                        <p for="checkbox-website" class="font-encodesans text-sm font-normal text-esg8">
                                            {{ __('Policy or strategy to address impacts on biodiversity and ecosystems') }}
                                        </p>
                                    </div>
                                    <div class="">
                                        @include('icons.checkbox', ['color' => color(2)])
                            ...
                            {{-- NEW --}}
                            <x-cards.card-dashboard-version1-withshadow
                                text="{{ json_encode([__('Raw-Materials Consumption')]) }}" class="!h-auto"
                                type="none" contentplacement="none">
                                <div class="flex items-center justify-between border-b border-b-esg7/40 w-full mt-10 pb-3">
                                    <div class="">
                                        <p for="checkbox-website" class="font-encodesans text-sm font-normal text-esg8">
                                            {{ __('Carried out new construction and/or major renovation work') }}</p>
                                    </div>
                                    <div class="">
                                        @include('icons.checkbox', ['color' => color(2)])
                                    </div>
                        ...
                        <div class="">
                            {{-- NEW --}}
                            <x-cards.card-dashboard-version1-withshadow
                                text="{{ json_encode([__('Organisation Activities Impact')]) }}" class="!h-auto"
                                type="none" contentplacement="none">
                                <div class="flex items-center justify-between border-b border-b-esg7/40 w-full mt-10 pb-3">
                                    <div class="">
                                        <p for="checkbox-website" class="font-encodesans text-sm font-normal text-esg8">
                                            {{ __('Activity fall within sectors with a high climate impact') }}</p>
                                    </div>
                                    <div class="">
                                        @include('icons.checkbox', ['color' => color(2)])
                                    </div>
                                ...
                                <div class="flex items-center justify-between border-b border-b-esg7/40 mt-5 pb-3">
                                    <div class="">
                                        <p for="checkbox-website" class="font-encodesans text-sm font-normal text-esg8">
                                            {{ __('Active in the fossil fuel sector') }}</p>
                                    </div>
                                    <div class="">
                                        @include('icons.checkbox', ['color' => color(2)])
                                    </div>
                                ...
                                <div class="flex items-center justify-between border-b border-b-esg7/40 mt-5 pb-3">
                                    <div class="">
                                        <p for="checkbox-website" class="font-encodesans text-sm font-normal text-esg8">
                                            {{ __('Involved in activities related to the manufacture or sale of controversial weapons') }}
                                        </p>
                                    </div>
                                    <div class="">
                                        @include('icons.checkbox', ['color' => color(2)])
                                ...
                                <div class="flex items-center justify-between border-b border-b-esg7/40 w-full mt-5 pb-3">
                                    <div class="">
                                        <p for="checkbox-website" class="font-encodesans text-sm font-normal text-esg8">
                                            {{ __('Conducts activities that are included in the manufacture of pesticides and other agrochemical products') }}
                                        </p>
                                    </div>
                                    <div class="">
                                        @include('icons.checkbox', ['color' => color(2)])
                                ...
                                <div class="flex items-center justify-between border-b border-b-esg7/40 mt-5 pb-3">
                                    <div class="">
                                        <p for="checkbox-website" class="font-encodesans text-sm font-normal text-esg8">
                                            {{ __('Conducts activities that contribute to land degradation, desertification, artificialisation and/or soil sealing') }}
                                        </p>
                                    </div>
                                    <div class="">
                                        @include('icons.checkbox', ['color' => color(2)])
                                ...
                                <div class="flex items-center justify-between border-b border-b-esg7/40 mt-5 pb-3">
                                    <div class="">
                                        <p for="checkbox-website" class="font-encodesans text-sm font-normal text-esg8">
                                            {{ __('Conducts activities that include exploiting seas and/or oceans') }}</p>
                                    </div>
                                    <div class="">
                                        @include('icons.checkbox', ['color' => color(2)])
                                    </div>
                                ...
                                <div class="flex items-center justify-between border-b border-b-esg7/40 mt-5 pb-3">
                                    <div class="">
                                        <p for="checkbox-website" class="font-encodesans text-sm font-normal text-esg8">
                                            {{ __('Activities in forest areas') }}</p>
                                    </div>
                                    <div class="">
                                        @include('icons.checkbox', ['color' => color(2)])
                                    </div>
                        ...
                        {{-- NEW --}}
                        <x-cards.card-dashboard-version1-withshadow
                            text="{{ json_encode([__('total building materials used')]) }}" class="!h-full"
                            contentplacement="none">
                            <div class="flex items-center justify-between w-full">
                                <div class="">
                                    <label for="checkbox-website"
                        ...
                        {{-- NEW --}}
                        <x-cards.card-dashboard-version1-withshadow
                            text="{{ json_encode([__('Recovered, recycled and/or of biological origin materials')]) }}"
                            class="!h-full" contentplacement="none">
                            <div class="flex items-center justify-between w-full">
                                <div class="">
                                    <label for="checkbox-website"
            ...
            <div class="mt-10 pagebreak print:mt-20" x-show="social">
                <div class="px-8 bg-esg1/10 rounded-3xl py-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mt-10 print:-mt-10 nonavoid">
                        <x-cards.card-dashboard-version1-withshadow
                            text="{{ json_encode([__('Gender Equality - Employees')]) }}" type="flex"
                            class="!h-[270px]" contentplacement="none">
                            <x-charts.donut id="gender_equility_employees" class="m-auto !h-[180px] !w-[180px]"
                                legendes="true" />
                        </x-cards.card-dashboard-version1-withshadow>

                        <x-cards.card-dashboard-version1-withshadow
                            text="{{ json_encode([__('Gender Equality - Outsourced workers')]) }}" type="flex"
                            class="!h-[270px]" contentplacement="none">
                        ...
                        <x-cards.card-dashboard-version1-withshadow
                            text="{{ json_encode([__('Gender Equality - Executives')]) }}" type="flex"
                            class="!h-[270px]" contentplacement="none">
                            <x-charts.donut id="gender_equality_executives" class="m-auto !h-[180px] !w-[180px]"
                                legendes="true" />
                        </x-cards.card-dashboard-version1-withshadow>

                        <x-cards.card-dashboard-version1-withshadow
                            text="{{ json_encode([__('Gender Equality - Leadership')]) }}" type="flex"
                            class="!h-[270px]" contentplacement="none">
                            <x-charts.donut id="gender_equality_leadership" class="m-auto !h-[180px] !w-[180px]"
                                legendes="true" />
                        </x-cards.card-dashboard-version1-withshadow>
                        ...
                        <x-cards.card-dashboard-version1-withshadow
                            ...
                            <div class="flex items-center justify-between w-full">
                                <div class="">
                                    <label for="checkbox-website"
                                        class="font-encodesans text-4xl font-medium text-esg8">11 <span
                        ...
                        <x-cards.card-dashboard-version1-withshadow text="{{ json_encode([__('Gender pay gap')]) }}"
                            ...
                            <div class="flex items-center justify-between w-full">
                                <div class="">
                                    <label for="checkbox-website"
                                        class="font-encodesans text-4xl font-medium text-esg8">30 <span
                                            class="text-base text-esg8">%</span></label>
                                </div>
                        ...
                        {{-- NEW --}}
                        <x-cards.card-dashboard-version1-withshadow
                            text="{{ json_encode([__('Workers satisfaction and conditions')]) }}" class="!h-min"
                            contentplacement="none">
                            <div class="flex items-center justify-between border-b border-b-esg7/40 w-full mt-5 pb-2">
                                <label for="checkbox-website"
                                    class="font-encodesans text-sm font-normal text-esg8">{{ __('Performance evaluation process for contract workers') }}</label>
                                <div class="">
                        ...
                        {{-- NEW --}}
                        <x-cards.card-dashboard-version1-withshadow text="{{ json_encode([__('Safety and health')]) }}"
                            class="!h-min" contentplacement="none">
                            <div class="flex items-center justify-between border-b border-b-esg7/40 w-full mt-5 pb-2">
                                <label for="checkbox-website"
                                    class="font-encodesans text-sm font-normal text-esg8">{{ __('Accidents at work during the reporting period') }}</label>
                                <div class="">
                                    @include('icons.checkbox', ['color' => color(1)])
                                </div>
                            </div>
                        ...
                        {{-- NEW --}}
                        <x-cards.card-dashboard-version1-withshadow
                            text="{{ json_encode([__('Number of accidents at work during the reporting'), __('period')]) }}"
                            class="!h-min" contentplacement="none">
                            <div class="flex items-center justify-between w-full">
                                <div class="">
                                    <label for="checkbox-website"
                                        class="font-encodesans text-4xl font-medium text-esg8">30 <span
                                            class="text-base text-esg8">{{ __('accidents') }}</span></label>
                                </div>
                        ...
                        <x-cards.card-dashboard-version1-withshadow
                            ...
                            <div class="flex items-center justify-between w-full">
                                <div class="">
                                    <label for="checkbox-website" class="font-encodesans text-4xl font-medium text-esg8">
                                        50 <span class="text-base text-esg8">{{ __('days') }}</span></label>
                                </div>
                        ...
                        <x-cards.card-dashboard-version1-withshadow
                            ...
                            <div class="flex items-center justify-between border-b border-b-esg7/40 w-full mt-10 pb-3">
                                <div class="">
                                    <p for="checkbox-website" class="font-encodesans text-sm font-normal text-esg8">
                                        {{ __('Training and capacity development') }}</p>
                                </div>
                                <div class="">
                                    @include('icons.checkbox', ['color' => color(1)])
                                </div>
                            ...
                            <div class="flex items-center justify-between border-b border-b-esg7/40 mt-5 pb-3">
                                <div class="">
                                    <p for="checkbox-website" class="font-encodesans text-sm font-normal text-esg8">
                                        {{ __('Trainning on the topics covered in the code of ethics and conduct during the reporting period') }}
                                    </p>
                                </div>
                                <div class="">
                                    @include('icons.checkbox', ['color' => color(1)])
                            ...
                            <div class="flex items-center justify-between border-b border-b-esg7/40 mt-5 pb-3">
                                <div class="">
                                    <p for="checkbox-website" class="font-encodesans text-sm font-normal text-esg8">
                                        {{ __('Trainning on preventing and combating corruption and bribery') }}</p>
                                </div>
                                <div class="">
                                    @include('icons.checkbox', ['color' => color(1)])
                                </div>
                        ...
                        <x-cards.card-dashboard-version1-withshadow
                            ...
                            <div class="flex items-center justify-between w-full">
                                <div class="">
                                    <label for="checkbox-website" class="font-encodesans text-4xl font-medium text-esg8">
                                        114 <span class="text-base text-esg8">{{ __('days') }}</span></label>
                                </div>
            ...
            <div class="mt-10 print:mt-20">
                <div class="px-8 bg-esg3/10 rounded-3xl py-8" x-show="governance">
                    ...
                    <x-cards.card-dashboard-version1-withshadow
                        ...
                        <div class="flex items-center justify-between border-b border-b-esg7/40 w-full mt-5 pb-2">
                            <label for="checkbox-website"
                                class="font-encodesans text-sm font-normal text-esg8">{{ __('Board of Directors with no Executive Members') }}</label>
                        </div>
                    </x-cards.card-dashboard-version1-withshadow>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mt-5">
                        <x-cards.card-dashboard-version1-withshadow
                            text="{{ json_encode([__('Highest governance bo distribution by gender')]) }}" type="flex"
                            contentplacement="none" class="!h-[270px]">
                        ...
                        {{-- NEW --}}
                        <x-cards.card-dashboard-version1-withshadow
                            text="{{ json_encode([__('Significant Incidents')]) }}" class="!h-auto" type="none"
                            contentplacement="none">
                            <div class="flex items-center justify-between border-b border-b-esg7/40 w-full mt-10 pb-3">
                                <div class="">
                                    <p for="checkbox-website" class="font-encodesans text-sm font-normal text-esg8">
                                        {{ __('Convicted of violations of anti-corruption and anti-bribery laws') }}</p>
                                </div>
                                <div class="">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mt-5">
                        <div class="grid grid-cols-1 gap-5">
                            ...
                            <x-cards.card-dashboard-version1-withshadow text="{{ json_encode([__('Annual revenue')]) }}"
                                ...
                                <div class="flex items-center justify-between w-full">
                                    <div class="">
                                        <label for="checkbox-website"
                                            class="font-encodesans text-4xl font-medium text-esg8">1.234.567 <span
                                                class="text-base text-esg8">€</span></label>
                                    </div>
                            ...
                            {{-- NEW --}}
                            <x-cards.card-dashboard-version1-withshadow
                                text="{{ json_encode([__('Annual net revenue')]) }}" class="!h-min"
                                contentplacement="none">
                                <div class="flex items-center justify-between w-full">
                                    <div class="">
                                        <label for="checkbox-website"
                                            class="font-encodesans text-4xl font-medium text-esg8">234.567 <span
                                                class="text-base text-esg8">€</span></label>
                                    </div>
                        ...
                        <div class="">
                            <x-cards.card-dashboard-version1-withshadow
                                text="{{ json_encode([__('Annual reporting')]) }}" class="!h-full" type="none"
                                contentplacement="none">
                                <div class="grid grid-cols-1 md:grid-cols-1 mt-10">
                                    <div class="flex items-center justify-between pb-2 border-b border-b-esg7/40 mb-3">
                                        <label for="checkbox-website"
                                            class="font-encodesans text-sm font-normal text-esg8 w-9/12">{{ __('Financial report') }}</label>
                                        <div class="">
                                            @include('icons.checkbox', [
                                                'color' => true ? color(3) : color(7),
                                            ])
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-center justify-between pb-2 border-b border-b-esg7/40 mb-3">
                                        <label for="checkbox-website"
                                            class="font-encodesans text-sm font-normal text-esg8 w-9/12">{{ __('Impact report') }}</label>
                                        <div class="">
                                            @include('icons.checkbox', [
                                                'color' => true ? color(3) : color(7),
                                            ])
                                    ...
                                    <div class="flex items-center justify-between pb-2 border-b border-b-esg7/40 mb-3">
                                        <label for="checkbox-policy"
                                            class="font-encodesans text-sm font-normal text-esg8 w-9/12">{{ __('Sustainability report') }}</label>
                                        <div class="">
                                            @include('icons.checkbox', [
                                                'color' => true ? color(3) : color(7),
                                            ])
                                    ...
                                    <div class="flex items-center justify-between pb-2 border-b border-b-esg7/40 mb-3">
                                        <label for="checkbox-pa"
                                            class="font-encodesans text-sm font-normal text-esg8 w-9/12">{{ __('Activities Report') }}</label>
                                        <div class="">
                                            @include('icons.checkbox', [
                                                'color' => true ? color(3) : color(7),
                                            ])
                                    ...
                                    <div class="flex items-center justify-between pb-2 border-b border-b-esg7/40 mb-3">
                                        <label for="checkbox-ethics"
                                            class="font-encodesans text-sm font-normal text-esg8 w-9/12">{{ __('Sales Report') }}</label>
                                        <div class="">
                                            @include('icons.checkbox', [
                                                'color' => true ? color(3) : color(7),
                                            ])
                                    ...
                                    <div class="flex items-center justify-between pb-2 border-b border-b-esg7/40 mb-3">
                                        <label for="checkbox-environmental"
                                            class="font-encodesans text-sm font-normal text-esg8 w-9/12">{{ __('Customer Satisfaction Report') }}</label>
                                        <div class="">
                                            @include('icons.checkbox', [
                                                'color' => true ? color(3) : color(7),
                                            ])
                                    ...
                                    <div class="flex items-center justify-between pb-2 border-b border-b-esg7/40 mb-3">
                                        <label for="checkbox-safety"
                                            class="font-encodesans text-sm font-normal text-esg8 w-9/12">{{ __('Employee Satisfaction Report') }}</label>
                                        <div class="">
                                            @include('icons.checkbox', [
                                                'color' => true ? color(3) : color(7),
                                            ])
        ...
        <div class="w-full flex mt-10 items-center justify-center">
            <x-buttons.a-icon
                class="bg-esg4 border-esg2 border rounded w-80 p-2 !text-center cursor-pointer hover:bg-esg2"
                href="{{ url('storage/documentation/dashboards/dash18/report-PMEs_PT.pdf') }}" target="_blank">
                <div class="flex gap-3 items-center place-content-center">
                    @include('icons.download')
                    <label class="ml-4 cursor-pointer">{{ __('Download PDF') }}</label>
                </div>
            </x-buttons.a-icon>
        </div>
