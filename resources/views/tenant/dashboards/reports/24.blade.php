                                    ...
                                    html += `
                                        <div class="grid w-full grid-cols-3">
                                            <div class="col-span-2 flex items-center">
                                                <div class="mr-2 inline-block rounded-full p-2 text-left" style="background-color:${backgroundColor}"></div>
                                                <div class="inline-block text-sm text-esg8">${labelText}</div>
                                            </div>
                                            <div class="text-right text-sm text-esg8 leading-10 flex items-center"> <span style="color:${backgroundColor}" class="text-sm font-bold">${percentag}</span>  (${formatNumber(value)})</div>
                                        </div>
                                    `;
                                } else {
                                    html += `
...
@section('content')
    <div class="px-4 lg:px-0">
        ...
        <div class="max-w-7xl mx-auto">
            {{-- Page 1 DONE--}}
            <x-report.pagewithimage url="/images/report/screen/page1.png" customlogo="icons.dashboard.24.st_logo">
                <div class="flex p-14 h-full flex-col justify-between">
                    <div class="">
                        @include('icons.dashboard.24.st_logo')
                    </div>
            ...
            {{-- Page 2 DONE--}}
            <x-report.pagewithimage url="/images/report/screen/page2.png" footer="true" header="true" customlogo="icons.dashboard.24.st_logo">
                <div class="">
            ...
            {{-- Page 3 DONE --}}
            <x-report.page customlogo="icons.dashboard.24.st_logo" title="{{ __('company overview') }}">
                <div class="grid grid-cols-3 print:grid-cols-3 gap-10 py-5">
                    ...
                    <div class="">
                        ...
                        <x-report.table.table>
                            ...
                            <x-report.table.tr>
                                <x-report.table.td class="w-10/12">{{ __('Annual R&D investment as a percentage of turnover.') }}</x-report.table.td>
                                <x-report.table.td>{{ $report['randd_turnover']['unit'] ?? '€' }} {{ $report['randd_turnover']['value'] }}</x-report.table.td>
                            </x-report.table.tr>
                            <x-report.table.tr>
                                <x-report.table.td class="w-10/12">{{ __('Percentage of turnover devoted to investments in relevant aspects of business sustainability in the last twelve months.') }}</x-report.table.td>
                                <x-report.table.td>{{ $report['business_sustainability']['unit'] ?? '€' }} {{ $report['business_sustainability']['value'] }}</x-report.table.td>
                            </x-report.table.tr>
                            <x-report.table.tr>
                                <x-report.table.td class="w-10/12">{{ __('Total expenditure on maintenance and safety as a percentage of turnover.') }}</x-report.table.td>
                                <x-report.table.td>{{ $report['safety_turnover']['unit'] ?? '€' }} {{ $report['safety_turnover']['value'] }}</x-report.table.td>
                            </x-report.table.tr>
                        </x-report.table.table>
                    </div>
                    ...
                    <div class="pt-7">
                        <x-report.table.table>
                            ...
                            @if ($report['listed_company'])
                                <x-report.table.tr>
                                    <x-report.table.td class="w-10/12">{{ __('Closing price per share') }}</x-report.table.td>
                                    <x-report.table.td>{{ $report['closing_price']['unit'] ?? '€' }} {{ $report['closing_price']['value'] }}</x-report.table.td>
                                </x-report.table.tr>
                                <x-report.table.tr>
                                    <x-report.table.td class="w-10/12">{{ __('Value of your organisation`s weighted average cost of capital') }}</x-report.table.td>
                                    <x-report.table.td>{{ $report['avg_capital_cost']['unit'] ?? '€' }} {{ $report['avg_capital_cost']['value'] }}</x-report.table.td>
                                </x-report.table.tr>
                                <x-report.table.tr>
                                    <x-report.table.td class="w-10/12">{{ __('Number of available shares of the organization') }}</x-report.table.td>
                                    <x-report.table.td>{{ $report['share_organization']['unit'] ?? '€' }} {{ $report['share_organization']['value'] }}</x-report.table.td>
                                </x-report.table.tr>
                                <x-report.table.tr>
                                    <x-report.table.td class="w-10/12">{{ __('Value of the organisation`s equity') }}</x-report.table.td>
                                    <x-report.table.td>{{ $report['value_organization']['unit'] ?? '€' }} {{ $report['value_organization']['value'] }}</x-report.table.td>
                                </x-report.table.tr>
                            @endif
                        </x-report.table.table>
                    </div>
            ...
            {{-- Page 4 DONE--}}
            <x-report.pagewithimage url="/images/report/screen/page4.png" footer="true" header="true" customlogo="icons.dashboard.24.st_logo">
                <div class="">
            ...
            {{-- Page 5 DONE  --}}
            <x-report.page customlogo="icons.dashboard.24.st_logo" title="{{ __('ESG’s scores') }}">
                <div class="py-5">
            ...
            {{-- Page 6.1 DONE--}}
            <x-report.pagewithimage  url="/images/report/screen/document.png" footer="true" header="true" customlogo="icons.dashboard.24.st_logo" footerborder="border-t-esg2">
                <div class="">
                    <p class="text-6xl font-extrabold uppercase text-esg5">{{ __('Documentation') }}</p>
                </div>
            </x-report.page>

            {{-- Page 6.2 DONE--}}
            <x-report.page customlogo="icons.dashboard.24.st_logo" title="{{ __('Documentation') }}">
                <div class="py-5">
                    <p class="text-lg font-bold text-esg8 uppercase">{{ __('documents') }}</p>
            ...
            {{-- Page 7 DONE--}}
            <x-report.pagewithimage  url="/images/report/screen/page7.png" footer="true" header="true" customlogo="icons.dashboard.24.st_logo" footerborder="border-t-esg2">
                <div class="">
            ...
            {{-- Page 8 DONE--}}
            <x-report.page customlogo="icons.dashboard.24.st_logo" title="{{ __('environment') }}" footerborder="border-t-esg2 !text-esg4" bgimage="/images/report/screen/page8_bg.png">
                <div class="py-5">
                    <div class="grid grid-cols-3 print:grid-cols-3 gap-10 mt-4 pb-40">
                        <div class="">
                            ...
                            <div class="mt-4">
                                <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs" text="{{ json_encode([__('Atmospheric Pollutants')]) }}" class="!h-auto !shadow-none !bg-transparent !p-0">
                        ...
                        <div class="">
                            ...
                            <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs" class="!h-auto !shadow-none !bg-transparent !p-0">
            ...
            {{-- Page 8.1 DONE--}}
            <x-report.page customlogo="icons.dashboard.24.st_logo" title="{{ __('environment') }}" footerborder="border-t-esg2 !text-esg4">
                <div class="py-5">
                    <div class="grid grid-cols-3 print:grid-cols-3 gap-10 mt-4">
                        ...
                        <div class="">
                            ...
                            <div class="">
                                <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs"  type="none" class="!h-auto shadow-none !bg-transparent !p-0" >
                            ...
                            <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs" text="{{ json_encode([__('Energy intensity')]) }}" class="!h-min " titleclass="!text-xs" contentplacement="none">
            ...
            <x-report.page customlogo="icons.dashboard.24.st_logo" title="{{ __('environment') }}" footerborder="border-t-esg2 !text-esg4">
                <div class="grid grid-cols-3 print:grid-cols-3 gap-10 py-5">
                    <div>
                        <div>
                            <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs"
                                text="{!! __('CONSUMPTION EXPENDITURE ON') !!}"
                                class="!h-auto !shadow-none !p-0"
                        ...
                        <div class="mt-4">
                            <img src="/images/report/screen/ac.png" >
                        </div>
                    </div>

                    <div>
                        <p class="lowercase text-base text-esg8">{!! __('TYPE OF REFRIGERANT GAS USED IN REFRIGERATION AND AIR CONDITIONING EQUIPMENT') !!}</p>
                        <x-report.table.table class="!border-t-esg2">
                    ...
                    <div>
                        <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs" text="{!! __('Company`s installed renewable energy generation capacity for self-consumption') !!}" titleclass="!text-xs" class="!h-auto" contentplacement="none">
                            <div class="flex items-center justify-between w-full">
                                <div class="">
                        ...
                        <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs" text="{!! __('energy consumption expenditure for vehicle travel as a percentage of turnover') !!}" titleclass="!text-xs" class="!h-auto !mt-4" contentplacement="none">
                            <div class="flex items-center justify-between w-full">
                                <div class="">
                        ...
                        <p class=" lowercase text-base text-esg8 mt-4">{!! __('COMPANY(IES) WITH WHICH THERE IS ELECTRICITY SUPPLY CONTRACT') !!}</p>
                ...
                <div class="grid grid-cols-3 print:grid-cols-3 gap-10 py-5">
                    <div class="col-span-2">
                        <div class="grid grid-cols-2 gap-10">
                            <div>
                                <p class="text-base text-esg8">{!! __('Type of fuel consumed by vehicles belonging to the company') !!}</p>
                            ...
                            <div>
                                <p class="text-base text-esg8">{!! __('Type of fuel consumed by fixed installations') !!}</p>
                        ...
                        <div class="mt-4">
                            <img src="/images/report/screen/energy.png" >
                        </div>
                    </div>
            ...
            {{-- Page 9 DONE--}}
            <x-report.page customlogo="icons.dashboard.24.st_logo" title="{{ __('environment') }}" footerborder="border-t-esg2">
                <div class="py-5">
                    <div class="grid grid-cols-3 gap-10">
                        ...
                        <div>
                            <div class="">
                                ...
                                <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs" type="flex" class="!h-auto !shadow-none !bg-transparent" contentplacement="none">
                                    @if ($waste_produced != null)
                                        <x-charts.donut id="waste_produced" class="m-auto !h-[180px] !w-[180px] print:!h-[150px] print:!w-[150px]" legendes="true" grid="1"/>
                                    @else
                                        <p class="text-center pt-10 w-full">{{ __('Data not found!') }}</p>
                                    @endif
                                </x-cards.card-dashboard-version1-withshadow>
            ...
            {{-- Page 10 DONE--}}
            <x-report.page customlogo="icons.dashboard.24.st_logo" title="{{ __('environment') }}" footerborder="border-t-esg2" bgimage="/images/report/screen/page10_bg.png">
                <div class="py-5">
                    <div class="grid grid-cols-3 print:grid-cols-3 gap-10 mt-4 pb-72">
                        ...
                        <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs" text="{{ json_encode([__('Water intensity')]) }}" class="!h-min" contentplacement="none">
                            <div class="flex items-center justify-between w-full">
                                <div class="">
             ...
             {{-- Page 12 DONE--}}
             <x-report.pagewithleftimage customlogo="icons.dashboard.24.st_logo" title="{{ __('environment') }}" footerborder="border-t-esg2" bgimage="/images/report/screen/page12_bg.png">
                <div class="py-5">
                    <div class="">
             ...
             {{-- Page 13 DONE --}}
             <x-report.pagewithrightimage customlogo="icons.dashboard.24.st_logo" title="{{ __('environment') }}" footerborder="border-t-esg2" bgimage="/images/report/screen/page13_bg.png">
                <div class="py-5">
                    <div class="">
            ...
            <x-report.page customlogo="icons.dashboard.24.st_logo" title="{{ __('environment') }}" footerborder="border-t-esg2 !text-esg4">
                <div class="grid grid-cols-3 gap-10 py-5">
                    <div class="col-span-2">
                        <p class="text-lg font-bold text-esg8 uppercase">{{ __('Circular economy practices of the company') }}</p>
                        <x-report.table.table class="!border-t-esg2">
                    ...
                    <div class="">
                        ...
                        <p class="text-base text-esg8 ">{{ __('Company promotes the analysis of the life cycle of products, CONSIDERING eco-design, reducing harmfulL substances AND facilitating theIR repairability AND recovery') }}</p>
                        <x-report.table.table class="!border-t-esg2">
                        ...
                        <p class="text-base text-esg8  mt-4">{{ __('Company facilitates and promotes appropriate channels with administrations, the scientific and technological community and economic and social agents to promote the transition to a circular ecosystem') }}</p>
                        <x-report.table.table class="!border-t-esg2">
             ...
             {{-- Page 14 DONE--}}
            <x-report.pagewithimage url="/images/report/screen/page14.png" footer="true" header="true" customlogo="icons.dashboard.24.st_logo" footerborder="border-t-esg1">
                <div class="">
            ...
            {{-- Page 15 DONE--}}
            <x-report.page customlogo="icons.dashboard.24.st_logo" title="{{ __('Social') }}" footerborder="border-t-esg1">
                <div class="py-5 print:py-0">
                    <div class="grid grid-cols-3 print:grid-cols-3 gap-5 mt-4">
                        ...
                        <div>
                            <div>
                                <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs" text="{{ json_encode([__('Contracted workers')]) }}"
                                    type="flex" class="!h-auto !shadow-none !bg-transparent" contentplacement="none" titleclass="!normal-case">
                                    @if ($contract_workers != null)
                                        <x-charts.donut id="contracted_workers" class="m-auto !h-[120px] !w-[120px] print:!h-[100px] print:!w-[100px]" legendes="true" grid="2" legendClass="!h-min"/>
                                    @else
                                        <p class="text-center pt-10 w-full">{{ __('Data not found!') }}</p>
                                    @endif
                                </x-cards.card-dashboard-version1-withshadow>
                            ...
                            <div>
                                <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs" text="{{ json_encode([__('Subcontracted workers')]) }}"
                                    type="flex" class="!h-auto !shadow-none !bg-transparent" contentplacement="none" titleclass="!normal-case">
                                    @if ($outsource_workers != null)
                                        <x-charts.donut id="outsourced_workers" class="m-auto !h-[120px] !w-[120px] print:!h-[100px] print:!w-[100px]" legendes="true" grid="2" legendClass="!h-min"/>
                                    @else
                                        <p class="text-center pt-10 w-full">{{ __('Data not found!') }}</p>
                                    @endif
                                </x-cards.card-dashboard-version1-withshadow>
                        ...
                        <div>
                            <div>
                                <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs" text="{{ json_encode([__('Top management (contracted workers)')]) }}"
                                    type="flex" class="!h-auto !shadow-none !bg-transparent" contentplacement="none" titleclass="!normal-case">
                                    @if ($top_management != null)
                                        <x-charts.donut id="top_management" class="m-auto !h-[120px] !w-[120px] print:!h-[100px] print:!w-[100px]" legendes="true" grid="2" legendClass="!h-min"/>
                                    @else
                                        <p class="text-center pt-10 w-full">{{ __('Data not found!') }}</p>
                                    @endif
                                </x-cards.card-dashboard-version1-withshadow>
                            ...
                            <div>
                                <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs" text="{{ json_encode([__('Top management (subcontracted workers)')]) }}"
                                    type="flex" class="!h-auto !shadow-none !bg-transparent" contentplacement="none" titleclass="!normal-case">
                                    @if ($report['top_management_outsource'] != null)
                                        <x-charts.donut id="top_outsourced_workers" class="m-auto !h-[120px] !w-[120px] print:!h-[100px] print:!w-[100px]" legendes="true" grid="2" legendClass="!h-min"/>
                                    @else
                                        <p class="text-center pt-10 w-full">{{ __('Data not found!') }}</p>
                                    @endif
                                </x-cards.card-dashboard-version1-withshadow>
                ...
                <div class="py-5">
                    <div class="grid grid-cols-3 print:grid-cols-3 gap-5 mt-4">
                        <div class="">
                            <div class="">
                                <div>
                                    <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs" text="{{ json_encode([__('Middle management (subcontracted workers)')]) }}"
                                        type="flex" class="!h-auto !shadow-none !bg-transparent" contentplacement="none" titleclass="!normal-case">
                                        @if ($report['middle_management'] != null)
                                            <x-charts.donut id="middle_outsourced_workers" class="m-auto !h-[180px] !w-[180px] print:!h-[100px] print:!w-[100px]" legendes="true" grid="2"/>
                                        @else
                                            <p class="text-center pt-10 w-full">{{ __('Data not found!') }}</p>
                                        @endif
                                    </x-cards.card-dashboard-version1-withshadow>
                                ...
                                <div>
                                    <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs" text="{{ json_encode([__('Middle management (contracted workers)')]) }}"
                                        type="flex" class="!h-auto !shadow-none !bg-transparent" contentplacement="none" titleclass="!normal-case">
                                        @if ($middle_management != null)
                                            <x-charts.donut id="middle_management" class="m-auto !h-[180px] !w-[180px] print:!h-[100px] print:!w-[100px]" legendes="true" grid="2"/>
                                        @else
                                            <p class="text-center pt-10 w-full">{{ __('Data not found!') }}</p>
                                        @endif
                                    </x-cards.card-dashboard-version1-withshadow>
                        ...
                        <div class="">
                            ...
                            <div class="mt-4">
                                <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs" text="{{ json_encode([__('Contracted workers receiving the national minimum wage by gender')]) }}"
                                    type="flex" class="!h-auto !shadow-none !bg-transparent" contentplacement="none" titleclass="!normal-case">
                                    @if ($report['minimum_wage'] != null)
                                        <x-charts.donut id="minimum_wage" class="m-auto !h-[180px] !w-[180px] print:!h-[100px] print:!w-[100px]" legendes="true" grid="2"/>
                                    @else
                                        <p class="text-center pt-10 w-full">{{ __('Data not found!') }}</p>
                                    @endif
                                </x-cards.card-dashboard-version1-withshadow>
                        ...
                        <div class="">
                            <div class="">
                                <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs" text="{{ json_encode([__('Workers Leaving the organisation, by gender')]) }}"
                                    type="flex" class="!h-auto !shadow-none !bg-transparent" contentplacement="none" titleclass="!normal-case">
                                    @if ($report['leaving_organisation'] != null)
                                        <x-charts.donut id="leaving_organisation" class="m-auto !h-[180px] !w-[180px] print:!h-[100px] print:!w-[100px]" legendes="true" grid="2"/>
                                    @else
                                        <p class="text-center pt-10 w-full">{{ __('Data not found!') }}</p>
                                    @endif
                                </x-cards.card-dashboard-version1-withshadow>
                            ...
                            <div class="">
                                ...
                                <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs" text="{{ json_encode([__('contracted Workers Turnover')]) }}" class="!h-min" contentplacement="none">
                                    <div class="flex items-center justify-between w-full">
                                        <div class="">
            ...
            <x-report.page customlogo="icons.dashboard.24.st_logo" title="{{ __('Social') }}" footerborder="border-t-esg1">
                <div class="py-5 print:py-0">
                    <div class="grid grid-cols-3 print:grid-cols-3 gap-5">
                        <div class="">
                            <div>
                                <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs" text="{{ json_encode([__('Average gross earnings per hour ')]) }}"  class="!h-min !shadow-none !bg-transparent !p-0">
                            ...
                            <div class="mt-4">
                                ...
                                <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs" text="{{ json_encode([__('Gender pay gap')]) }}" class="!h-auto" contentplacement="none">
                                    <div class="flex items-center justify-between w-full">
                                        <div class="">
                        ...
                        <div class="">
                            <div class="">
                                <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs" text="{{ json_encode([__('bonuses (variable remuneration) paid as a percentage of turnover')]) }}" class="!h-auto" contentplacement="none">
                                    <div class="flex items-center justify-between w-full">
                                        <div class="">
                            ...
                            <div class="mt-4">
                                <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs" text="{{ json_encode([__('full-time employees receiving 90% of total bonuses (variable remuneration)')]) }}" class="!h-auto" contentplacement="none">
                                    <div class="flex items-center justify-between w-full">
                                        <div class="">
                            ...
                            <div class="mt-4">
                                <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs" text="{{ json_encode([__('Total gross annual remuneration including prize money of the highest paid individual')]) }}" class="!h-auto" contentplacement="none">
                                    <div class="flex items-center justify-between w-full">
                                        <div class="">
                                            <x-cards.cards-value-unit :value="$report['annual_remuneration']['value']" :unit="$report['annual_remuneration']['unit'] ?? '€'" />
                                        </div>
                            ...
                            <div class="mt-4">
                                <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs" text="{{ json_encode([__('Average annual gross total remuneration including bonus money of all contracted workers (excluding the highest paid individual)')]) }}" class="!h-auto" contentplacement="none">
                                    <div class="flex items-center justify-between w-full">
                                        <div class="">
                                            <x-cards.cards-value-unit :value="$report['gross_remuneration']['value']" :unit="$report['gross_remuneration']['unit'] ?? '€'" />
                                        </div>
                        ...
                        <div class="">
                            <div>
                                <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs" text="{{ json_encode([__('customers surveyed who consider themselves satisfied')]) }}" class="!h-auto" contentplacement="none">
                                    <div class="flex items-center justify-between w-full">
                                        <div class="">
            ...
            <x-report.page customlogo="icons.dashboard.24.st_logo" title="{{ __('Social') }}" footerborder="border-t-esg1">
                <div class="grid grid-cols-3 gap-5 py-5">
                    <div>
                        <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs" text="{{ json_encode([__('Number of accidents at work during the reporting'), __('period')]) }}" class="!h-min" contentplacement="none">
                            <div class="flex items-center justify-between w-full">
                                <div class="">
                        ...
                        <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs" text="{{ json_encode([__('Days lost due to injury, accident, death or illness')]) }}" class="!h-auto !mt-4" contentplacement="none">
                            <div class="flex items-center justify-between w-full">
                                <div class="">
                        ...
                        <div class="mt-4">
                            <img src="/images/report/screen/bg17.png">
                        </div>
                    </div>

                    <div>
                        <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs" text="{{ json_encode([__('employees who have suffered accidents at work that required external medical attention')]) }}" class="!h-auto" contentplacement="none">
                            <div class="flex items-center justify-between w-full">
                                <div class="">
                    ...
                    <div>
                        ...
                        <div class="mt-4">
                            <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs" text="{{ json_encode([__('Number of hours on training')]) }}" class="!h-min" contentplacement="none">
                                <div class="flex items-center justify-between w-full">
                                    <div class="">
                            ...
                            <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs" text="{{ json_encode([__('Average training expenditure per full-time employee')]) }}" class="!h-min !mt-4" contentplacement="none">
                                <div class="flex items-center justify-between w-full">
                                    <div class="">
            ...
            {{-- Page 19 DONE--}}
            <x-report.pagewithimage url="/images/report/screen/page19.png" footer="true" header="true" customlogo="icons.dashboard.24.st_logo" footerborder="border-t-esg3">
                <div class="">
            ...
            {{-- Page 20 DONE--}}
            <x-report.page customlogo="icons.dashboard.24.st_logo" title="{{ __('governance') }}" footerborder="border-t-esg3">
                <div class="py-5 print:py-0">
                    <div class="grid grid-cols-3 print:grid-cols-3 gap-5 mt-4">
                        <div class="">
                            <div>
                        ...
                        <div class="">
                            <div class="mt-4">
                                <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs" text="{{ json_encode([__('Members of the highest governance body')]) }}"
                ...
                <div class="py-5 print:py-0">
                    <div class="grid grid-cols-3 print:grid-cols-3 gap-5">
                        <div class="">
                            ...
                            <div class="mt-2">
                                <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs" text="{{ json_encode([ __('Amount of the fines due to violations of anti-bribery and anti-corruption laws') ]) }}" class="!h-min" contentplacement="none">
                                    <div class="flex items-center justify-between w-full">
                                        <div class="">
                            ...
                            <div class="mt-2">
                                <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs" text="{{ json_encode([ __('incidents of discrimination') ]) }}" class="!h-auto" contentplacement="none">
                                    <div class="flex items-center justify-between w-full">
                                        <div class="">
            ...
            <x-report.page customlogo="icons.dashboard.24.st_logo" title="{{ __('governance') }}" footerborder="border-t-esg3">
                <div class="grid grid-cols-3 gap-5 py-5">
                    <div>
                        <p class="text-lg font-bold uppercase text-esg8 my-4">{{ __('company products') }}</p>
                        <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs"
                    ...
                    <div>
                        <div >
                            <p class="text-lg text-esg8"> {!! __('Percentage of total products/services by objective') !!} </p>
                            <x-report.table.table class="!border-t-esg3">
                                @foreach($product_services as $row)
                                    <x-report.table.tr>
                                        <x-report.table.td>{{ $row['label'] }}</x-report.table.td>
                                        <x-report.table.td>
                                            <p><span class="text-lg font-medium">{{ $row['value'] }}</span> {{ $row['unit'] }}</p>
                                        </x-report.table.td>
                                    </x-report.table.tr>
                                @endforeach
                            </x-report.table.table>
            ...
            {{-- Page 24 DONE--}}
            <x-report.pagewithimage url="/images/report/screen/polution.png" footer="true" header="true" customlogo="icons.dashboard.24.st_logo" footerborder="border-t-esg5">
                <div class="">
                    <p class="text-6xl text-esg16 mt-3 uppercase">{{ __('Additional section:') }}</p>
                    <p class="text-6xl font-extrabold uppercase text-esg5">{{ __('Carbon Footprint') }}</p>
                </div>
            </x-report.page>

            {{-- Page 25 DONE--}}
            <x-report.page customlogo="icons.dashboard.24.st_logo" title="{{ __('Carbon Footprint') }}" footerborder="border-t-esg5">
                <div class="grid grid-cols-3 gap-5 py-5">
                    <div>
                        <p class="text-lg font-bold text-esg8 uppercase">{!! __('Information for the Calculation of the Carbon Footprint') !!}</p>
                        <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs"
                            ...
                            <div class="flex items-center justify-between w-full">
                                ...
                                <div class="-mt-3">
                                    @include('icons.dashboard.gestao-energia', ['color' =>  color(5)])
                                </div>
                            </div>
                        </x-cards.card-dashboard-version1-withshadow>

                        <p class="text-lg  text-esg8 mt-4">{!! __('Company(ies) with which there is electricity supply contract') !!}</p>
                        <div class="mt-4">
                    ...
                    <div>
                        <p class="text-lg  text-esg8 mt-4">{!! __('Type of fuel consumed by vehicles belonging to the company') !!}</p>
                        <div class="mt-4">
                            <x-report.table.table class="!border-t-esg5">
                        ...
                        <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs"
                            ...
                            <div class="flex items-center justify-between w-full">
                                ...
                                <div class="-mt-3">
                                    @include('icons.dashboard.solar', ['fill' =>  color(5)])
                                </div>
                            </div>
                        </x-cards.card-dashboard-version1-withshadow>
                        ...
                        <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs"
                            ...
                            <div class="flex items-center justify-between w-full">
                                ...
                                <div class="-mt-3">
                                    @include('icons.dashboard.green_energey', ['fill' =>  color(5)])
                                </div>
                            </div>
                        </x-cards.card-dashboard-version1-withshadow>
                    </div>
                    ...
                    <div>
                        <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs"
                            ...
                            <div class="flex items-center justify-between w-full">
                                ...
                                <div class="-mt-3">
                                    @include('icons.dashboard.capa', ['fill' =>  color(5)])
                                </div>
                            </div>
                        </x-cards.card-dashboard-version1-withshadow>
                        ...
                        <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs"
                            ...
                            <div class="flex items-center justify-between w-full">
                                ...
                                <div class="-mt-3">
                                    @include('icons.dashboard.8.money-hand', ['color' =>  color(5)])
                                </div>
                            </div>
                        </x-cards.card-dashboard-version1-withshadow>
            ...
            <x-report.page customlogo="icons.dashboard.24.st_logo" title="{{ __('Carbon Footprint') }}" footerborder="border-t-esg5">
                <div class="grid grid-cols-3 gap-5 py-5">
                    <div>
                        <x-cards.card-dashboard-version1-withshadow titleclass="!text-xs"
                            ...
                            <div class="flex items-center justify-between w-full">
                                ...
                                <div class="-mt-3">
                                    @include('icons.dashboard.ac', ['color' =>  color(5)])
                                </div>
                            </div>
                        </x-cards.card-dashboard-version1-withshadow>
                    ...
                    <div>
                        <p class="text-lg  text-esg8 mt-4">{!! __('Type of refrigerant gas used in refrigeration and air conditioning equipment') !!}</p>
                        <div class="mt-4">
                            <x-report.table.table class="!border-t-esg5">
             ...
             {{-- Page 27 DONE--}}
             <x-report.page customlogo="icons.dashboard.24.st_logo" title="{{ __('governance') }}" footerborder="border-t-esg3" lastpage="true" noheader="true" customlogo="icons.dashboard.24.st_logo" nofooter="true">
                <div >
