        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="pagebreak print:-mt-[150px]" >
                <div class="pagebreak print:h-full">
                    <img src="/images/dashboard/screen-report-cover.jpeg" class="">
                ...
                <div class="pagebreak print:h-full hidden print:block">
                    <img src="/images/dashboard/chapter_1_cover.jpg" class="h-[1100px]">
                ...
                {{-- Enviroment --}}
                <div class="pagebreak print:h-full hidden print:block">
                    <img src="/images/dashboard/chapter_2_cover.jpg" class="h-[1100px] w-[100%]">
                        ...
                        <x-cards.card-dashboard-version1 text="{{ $text }}" class="print:!mt-5">
                            <div class="text-esg25 font-encodesans text-5xl font-bold pb-10">
                                <div class="grid grid-cols-6 gap-3">
                                    <div class="w-full">
                                        @include('icons.goals.1', ['class' => 'inline-block', 'color' => in_array(1, $charts['sdgs_top5']) ? '#EA1D2D' : '#DCDCDC'])
                                    </div>

                                    <div class="w-full">
                                        @include('icons.goals.2', ['class' => 'inline-block', 'color' => in_array(2, $charts['sdgs_top5']) ? '#D19F2A' : '#DCDCDC'])
                                    </div>

                                    <div class="w-full">
                                        @include('icons.goals.3', ['class' => 'inline-block', 'color' => in_array(3, $charts['sdgs_top5']) ? '#2D9A47' : '#DCDCDC'])
                                    </div>

                                    <div class="w-full">
                                        @include('icons.goals.4', ['class' => 'inline-block', 'color' => in_array(4, $charts['sdgs_top5']) ? '#C22033' : '#DCDCDC'])
                                    </div>

                                    <div class="w-full">
                                        @include('icons.goals.5', ['class' => 'inline-block', 'color' => in_array(5, $charts['sdgs_top5']) ? '#EF412A' : '#DCDCDC'])
                                    </div>

                                    <div class="w-full">
                                        @include('icons.goals.6', ['class' => 'inline-block', 'color' => in_array(6, $charts['sdgs_top5']) ? '#00ADD8' : '#DCDCDC'])
                                    </div>

                                    <div class="w-full">
                                        @include('icons.goals.7', ['class' => 'inline-block', 'color' => in_array(7, $charts['sdgs_top5']) ? '#FDB714' : '#DCDCDC'])
                                    </div>

                                    <div class="w-full">
                                        @include('icons.goals.8', ['class' => 'inline-block', 'color' => in_array(8, $charts['sdgs_top5']) ? '#8F1838' : '#DCDCDC'])
                                    </div>

                                    <div class="w-full">
                                        @include('icons.goals.9', ['class' => 'inline-block', 'color' => in_array(9, $charts['sdgs_top5']) ? '#F36E24' : '#DCDCDC'])
                                    </div>

                                    <div class="w-full">
                                        @include('icons.goals.10', ['class' => 'inline-block', 'color' => in_array(10, $charts['sdgs_top5']) ? '#E01A83' : '#DCDCDC'])
                                    </div>

                                    <div class="w-full">
                                        @include('icons.goals.11', ['class' => 'inline-block', 'color' => in_array(11, $charts['sdgs_top5']) ? '#F99D25' : '#DCDCDC'])
                                    </div>

                                    <div class="w-full">
                                        @include('icons.goals.12', ['class' => 'inline-block', 'color' => in_array(12, $charts['sdgs_top5']) ? '#CD8B2A' : '#DCDCDC'])
                                    </div>

                                    <div class="w-full">
                                        @include('icons.goals.13', ['class' => 'inline-block', 'color' => in_array(13, $charts['sdgs_top5']) ? '#48773C' : '#DCDCDC'])
                                    </div>

                                    <div class="w-full">
                                        @include('icons.goals.14', ['class' => 'inline-block', 'color' => in_array(14, $charts['sdgs_top5']) ? '#007DBB' : '#DCDCDC'])
                                    </div>

                                    <div class="w-full">
                                        @include('icons.goals.15', ['class' => 'inline-block', 'color' => in_array(15, $charts['sdgs_top5']) ? '#40AE49' : '#DCDCDC'])
                                    </div>

                                    <div class="w-full">
                                        @include('icons.goals.16', ['class' => 'inline-block', 'color' => in_array(16, $charts['sdgs_top5']) ? '#00558A' : '#DCDCDC'])
                                    </div>

                                    <div class="w-full">
                                        @include('icons.goals.17', ['class' => 'inline-block', 'color' => in_array(17, $charts['sdgs_top5']) ? '#1A3668' : '#DCDCDC'])
                                    </div>
                                </div>
                            </div>
                        </x-cards.card-dashboard-version1>
                ...
                <div class="pagebreak mt-10 print:mt-20">
                    ...
                    <div class="grid grid-cols-3 gap-5">
                        @if($charts['co2_emissions'])
                            @php $text = json_encode([__('GHG Emissions (t CO2 eq)')]); @endphp
                        ...
                        @if($report['atmospheric_pollutants'])
                            @php $text = json_encode([__('Atmospheric pollutants'), __('(t eq pollutants)')]); @endphp
                            <x-cards.card-dashboard-version1 text="{{ $text }}" class="!mt-5 !h-[250px]">
                        ...
                        @if($report['ozone_depleting'])
                            @php $text = json_encode([__('Ozone depleting substances'), __('(t eq ODS)')]); @endphp
                            <x-cards.card-dashboard-version1 text="{{ $text }}" class="!mt-5 !h-[250px]">
                ...
                <div class="pagebreak print:mt-20">
                    ...
                    <div class="grid grid-cols-2 gap-5 mt-5 print:mt-0">
                        @if(is_numeric($charts['water_consumption']))
                            ...
                            <x-cards.card-dashboard-version1 text="{{ $text }}" class="!h-[300px] relative print:!mt-5">
                                <p class="text-esg8 font-medium text-5xl absolute w-full  text-center mt-24 -ml-4">{{ $charts['water_consumption'] }} <span class="text-esg8 font-normal text-base">m3</span></p>
                                @include('icons.dashboard.liquid', ['color' => color(2)])
                            </x-cards.card-dashboard-version1>
                        @endif

                        @if(is_numeric($report['recycled_water']))
                            ...
                            <x-cards.card-dashboard-version1 text="{{ $text }}" class="!h-[300px] print:!mt-5">
                                <x-charts.icon-number value="{{ $report['recycled_water'] }}" unit="t">
                ...
                <div class="pagebreak print:h-full mt-10 print:mt-0 hidden print:block">
                    <img src="/images/dashboard/chapter_3_cover.jpg" class="h-[1100px] w-[100%]">
                ...
                <div class="pagebreak mt-10 print:mt-20">
                    ...
                    <div class="grid grid-cols-2 gap-5">
                        ...
                        @if(is_numeric($charts['work_days_lost']))
                            ...
                            @endphp
                            <x-cards.card-dashboard-version1 text="{{ $text }}" class="!h-[250px] print:!mt-5">
                                <x-charts.icon-number value="{{ $charts['work_days_lost'] }}" >
                                    @include('icons.dashboard.work-accident', ['class' => 'inline-block ml-2', 'width' => 50, 'height' => 50])
                                </x-charts.icon-number>
                            </x-cards.card-dashboard-version1>
                        @endif

                        @if(is_numeric($report['gender_pay_gap']))
                            @php
                                $text = json_encode([__('Gender pay gap')]);
                            @endphp
                            <x-cards.card-dashboard-version1 text="{{ $text }}" class="!h-[250px] print:!mt-5">
                                <x-charts.icon-number value="{{ $report['gender_pay_gap'] }}" unit="%">
                ...
                {{-- Governance --}}
                <div class="pagebreak print:h-full mt-10 print:mt-0 hidden print:block">
                    <img src="/images/dashboard/chapter_4_cover.jpg" class="h-[1100px] w-[100%]">
                ...
                <div class="pagebreak mt-10 print:mt-0 print:h-full hidden print:block">
                    <img src="/images/dashboard/chapter_5_cover.jpg" class="h-[1100px] w-[100%]">
                ...
                <div class="pagebreak print:mt-20">
                    ...
                    <p class="text-esg8 font-normal text-xs mt-5"> {{ $report['statement_responsability'] }} </p>
                ...
                <div class="print:h-full  hidden print:block">
                    <img src="/images/dashboard/back_cover.jpg" class="h-[1100px] w-[100%]">
