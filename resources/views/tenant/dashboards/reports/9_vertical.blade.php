                    ...
                    if (labels != null) {
                            ...
                            chart.data.datasets[0].data.forEach((datavale, i) => {
                                ...
                                if (id != 'energy_consumption_reporting' && id != 'energy_consumption_baseline') {
                                    html += `
                                        <div class="grid w-full grid-cols-3 mb-2">
                                            ...
                                            <div class="text-right text-sm text-esg8 flex gap-1 justify-center"> <span style="color:${backgroundColor}" class="text-sm font-bold">${percentag}</span>  (${value})</div>
                                        </div>
                                    `;
                                } else {
                                    html += `
...
@section('content')
    <div class="px-4 lg:px-0">
        ...
        <div class="max-w-7xl mx-auto">
            {{-- Page 1 DONE--}}
            <x-report.vertical.home url="/images/report/screen/vertical/1.png">
            ...
            {{-- Page 2 DONE--}}
            <x-report.vertical.pagewithimage url="/images/report/screen/vertical/2.png" header="true">
                <div class="">
            ...
            {{-- Page 4 DONE--}}
            <x-report.vertical.pagewithimage url="/images/report/screen/vertical/3.png" header="true">
                <div class="">
                    <p class="text-6xl text-esg16 mt-3 uppercase text-center">{{ __('ESG’s') }}</p>
                    <p class="text-6xl font-extrabold uppercase text-esg5 text-center">{{ __('scores') }}</p>
                </div>
            </x-report.vertical.pagewithimage>
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        <div class="grid justify-center">
                            ...
                            @if ($readiness['current_level'] === 0)
                                ...
                                <p class="text-base text-esg8 mt-2">{{ __('The organisation is committed to the core themes of the ESG pillars and has defined and implemented a set of basic policies relating to them.') }}</p>
                                <p class="text-base text-esg8 mt-2">{{ __('The organisation has the necessary foundations to ensure its future growth and development, and a commitment to acquiring additional knowledge is recommended.') }}</p>
                            @endif

                            @if ($readiness['current_level'] == 1)
                                <p class="text-4xl font-bold text-esg5 text-center mt-4">{{ __('Knowledge Ready') }}</p>

                                <p class="text-base text-esg8 mt-2">{{ __('The organisation is committed to implementing a set of training programmes, practices and processes that ensure the implementation of the policies defined by the organisation in the areas of health and safety at work, ethics and conduct, human rights, anti-corruption and conflicts of interest.') }}</p>
                                <p class="text-base text-esg8 mt-2">{{ __('There is a clear effort to improve the organisations conditions with regard to ESG themes, and there is room for progress.') }}</p>
                            @endif
                            ...
                            @if ($readiness['current_level'] == 2)
                                ...
                                <p class="text-base text-esg8 mt-2">{{ __('The organisations performance is oriented towards transparency, credibility and evolution and, as such, continuous investment in ESG issues is encouraged.') }}</p>
                            @endif

                            @if ($readiness['current_level'] == 3)
                                <p class="text-4xl font-bold text-esg5 text-center mt-4">{{ __('Maturity Ready') }}</p>

                                <p class="text-base text-esg8 mt-2">{{ __('The organisation is highly committed to complying with and respecting the ESG pillars and has begun to define and implement strategies that contribute to reducing, mitigating and preventing their impacts.') }}</p>
                                <p class="text-base text-esg8 mt-2">{{ __('It is notable for its external collaborations in the field of sustainability and for its contribution to sustainable development objectives within the scope of its activity.') }}</p>
                                <p class="text-base text-esg8 mt-2">{{ __('The efforts made by the organisation give it credibility and reputation, setting an example for others.') }}</p>
                            @endif
                            ...
                            @if ($readiness['current_level'] == 4 || $readiness['current_level'] == 5)
                                ...
                                <p class="text-base text-esg8 mt-2">{{ __('This means that you are more than ready to try out the in-depth questionnaire.') }}</p>
                            @endif
                        </div>

                        <div class="mt-4">
                            <p class="text-base text-esg8 mb-4 font-medium uppercase"> {{ __('Achievements') }} </p>
                            ...
                            @if ($readiness['current_level'] == 3)
                                <div class="flex items-start gap-2 mt-9">
                                    <div class="flex items-center gap-5">
            ...
            <x-report.vertical.page title="{{ __('ESG’s scores') }}">
                <div class="py-5">
                    ...
                    <div class="grid grid-cols-1 gap-4 mt-4">
                        ...
                        <div class="">
                            <p class="text-base font-medium text-esg8 uppercase">{{ __('ACTION PLAN') }}</p>
                            @if ($action_plan_table)
                                <div id="action_list" class="md:col-span-1 print:p-2 h-auto overflow-x-auto">
                                    <table class="text-esg8/70 font-encodesans w-full table-auto">
                                        <tbody class="font-medium">
                                            @foreach ($action_plan_table as $initiative)
                                                <tr class="text-xs action_plan_tr print:!pt-3 action_plan_{{ $loop->index + 1 }}">
            ...
            {{-- Page 7 DONE--}}
            <x-report.vertical.pagewithimage url="/images/report/screen/vertical/4.png" header="true" border="border-b-esg2">
                <div class="">
                ...
                <div class="py-5">
                    <div class="grid grid-cols-1 gap-4 mt-4">
                        <div class="">
                            ...
                            <x-report.table.table margin="!mt-2" class="!border-t-esg2">
                                <x-report.table.tr>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            @endphp
                            <x-cards.card-dashboard-version1-withshadow text="{{ json_encode([__('Atmospheric Pollutants')]) }}" subpoint="{{ $subpoint }}" class="!h-auto !shadow-none border border-esg7/40">
                            ...
                            @endphp
                            <x-cards.card-dashboard-version1-withshadow text="{{ json_encode([__('Ozone layer depleting substances')]) }}" subpoint="{{ $subpoint }}" class="!h-auto !shadow-none border border-esg7/40">
                        ...
                        <div class="">
                            ...
                            @endphp
                            <x-cards.card-dashboard-version1-withshadow text="{{ json_encode([__('GHG emissions by category')]) }}" subpoint="{{ $subpoint }}" class="!h-min !shadow-none border border-esg7/40" contentplacement="none">
            ...
            <x-report.vertical.page title="{{ __('environment') }}">
                <div class="py-5">
                    <div class="grid grid-cols-1 gap-4">
                        <div class="">
                            <p class="text-lg font-medium text-esg8 uppercase">{{ __('Energy consumption') }}</p>
                            <x-report.table.table margin="!mt-2" class="!border-t-esg2">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="border border-esg7/40 p-4 h-min rounded-md">
                        ...
                        <div class="">
                            <p class="text-lg font-bold text-esg8 uppercase">{{ __('Waste management') }}</p>
                        ...
                        <div class="border border-esg7/40 p-4 h-auto rounded-md">
                            <p class="text-base text-esg8">{{ __('Total waste generated (in the reporting period)') }}</p>
            ...
            <x-report.vertical.page title="{{ __('environment') }}">
                <div class="py-5">
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <x-cards.card-dashboard-version1-withshadow text="{{ json_encode([__('Water intensity')]) }}" class="!h-min !shadow-none border border-esg7/40 !w-6/12 print:w-8/12" contentplacement="none">
                            <div class="flex items-center justify-between w-full">
                                <div class="">
                ...
                <div class="py-5">
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <x-cards.card-dashboard-version1-withshadow text="{{ json_encode([__('total building materials used')]) }}" class="!h-auto !shadow-none border border-esg7/40" contentplacement="none">
                                <div class="flex items-center justify-between w-full">
                                    <div class="">
                            ...
                            <x-cards.card-dashboard-version1-withshadow text="{{ json_encode([__('Recovered, recycled and/or of biological origin materials')]) }}" class="!h-auto !shadow-none border border-esg7/40" contentplacement="none">
                                <div class="flex items-center justify-between w-full">
                                    <div class="">
             ...
             {{-- Page 14 DONE--}}
            <x-report.vertical.pagewithimage url="/images/report/screen/vertical/5.png" header="true" border="border-b-esg1">
                <div class="">
                ...
                <div class="">
                    <div class="grid grid-cols-1 gap-4">
                        <div class="">
                            ...
                            <div class="mt-2 border border-esg7/40 p-4 h-min rounded-md w-5/12 flex justify-between gap-4 justify-center">
                                <div>
                                    <p class="text-xs text-esg8 uppercase">{{ __('Total of contracted and subcontracted workers') }}</p>
                                    <label for="checkbox-website" class="font-encodesans text-sm font-medium text-esg8 mt-2">{{ $report['subcontract_workers']['value'] }} <span class="text-xs font-medium text-esg8">{{ __('workers') }}</span></label>
                                </div>
                                <div>
                            ...
                            <x-report.table.table margin="!mt-2" class="!border-t-esg1">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="">
                                <x-cards.card-dashboard-version1-withshadow text="{{ json_encode([__('Subcontracted workers')]) }}"
                                    type="flex" class="!h-min !shadow-none border border-esg7/40" contentplacement="none">
                                    @if ($outsource_workers != null)
                                        <x-charts.donut id="outsourced_workers" class="m-auto !h-[180px] !w-[180px] print:!h-[100px] print:!w-[100px]" legendes="true" />
                                    @else
                                        <p class="text-center pt-10 w-full">{{ __('Data not found!') }}</p>
                                    @endif
                                </x-cards.card-dashboard-version1-withshadow>
                            ...
                            <div class="">
                                <x-cards.card-dashboard-version1-withshadow text="{{ json_encode([__('Middle management (subcontracted workers)')]) }}"
                                    type="flex" class="!h-min !shadow-none border border-esg7/40" contentplacement="none">
                                    @if ($report['middle_management'] != null)
                                        <x-charts.donut id="middle_outsourced_workers" class="m-auto !h-[180px] !w-[180px] print:!h-[100px] print:!w-[100px]" legendes="true"/>
                                    @else
                                        <p class="text-center pt-10 w-full">{{ __('Data not found!') }}</p>
                                    @endif
                                </x-cards.card-dashboard-version1-withshadow>
                            ...
                            <div class="">
                                <x-cards.card-dashboard-version1-withshadow text="{{ json_encode([__('Top management (subcontracted workers)')]) }}"
                                    type="flex" class="!h-min !shadow-none border border-esg7/40" contentplacement="none">
                                    @if ($report['top_management_outsource'] != null)
                                        <x-charts.donut id="top_outsourced_workers" class="m-auto !h-[180px] !w-[180px] print:!h-[100px] print:!w-[100px]" legendes="true"/>
                                    @else
                                        <p class="text-center pt-10 w-full">{{ __('Data not found!') }}</p>
                                    @endif
                                </x-cards.card-dashboard-version1-withshadow>
                            ...
                            <div class="">
                                <x-cards.card-dashboard-version1-withshadow text="{{ json_encode([__('Contracted workers')]) }}"
                                    type="flex" class="!h-min !shadow-none border border-esg7/40" contentplacement="none">
                                    @if ($contract_workers != null)
                                        <x-charts.donut id="contracted_workers" class="m-auto !h-[180px] !w-[180px] print:!h-[100px] print:!w-[100px]" legendes="true"/>
                                    @else
                                        <p class="text-center pt-10 w-full">{{ __('Data not found!') }}</p>
                                    @endif
                                </x-cards.card-dashboard-version1-withshadow>
                            ...
                            <div class="">
                                <x-cards.card-dashboard-version1-withshadow text="{{ json_encode([__('Middle management (contracted workers)')]) }}"
                                    type="flex" class="!h-min !shadow-none border border-esg7/40" contentplacement="none">
                                    @if ($middle_management != null)
                                        <x-charts.donut id="middle_management" class="m-auto !h-[180px] !w-[180px] print:!h-[100px] print:!w-[100px]" legendes="true"/>
                                    @else
                                        <p class="text-center pt-10 w-full">{{ __('Data not found!') }}</p>
                                    @endif
                                </x-cards.card-dashboard-version1-withshadow>
                            ...
                            <div class="">
                                <x-cards.card-dashboard-version1-withshadow text="{{ json_encode([__('Top management (contracted workers)')]) }}"
                                    type="flex" class="!h-min !shadow-none border border-esg7/40" contentplacement="none" >
                                    @if ($top_management != null)
                                        <x-charts.donut id="top_management" class="m-auto !h-[180px] !w-[180px] print:!h-[100px] print:!w-[100px]" legendes="true" />
                                    @else
                                        <p class="text-center pt-10 w-full">{{ __('Data not found!') }}</p>
                                    @endif
                                </x-cards.card-dashboard-version1-withshadow>
            ...
            <x-report.vertical.page title="{{ __('Social') }}" >
                <div class="">
                    <div class="grid grid-cols-1 gap-4">
                            ...
                            <div>
                                <x-cards.card-dashboard-version1-withshadow text="{{ json_encode([__('Contracted workers receiving the national minimum wage by gender')]) }}"
                                    ...
                                    @if ($report['minimum_wage'] != null)
                                        <x-charts.donut id="minimum_wage" class="m-auto !h-[180px] !w-[180px] print:!h-[120px] print:!w-[120px]" legendes="true"/>
                                    @else
                                        <p class="text-center pt-10 w-full">{{ __('Data not found!') }}</p>
                                    @endif
                                </x-cards.card-dashboard-version1-withshadow>
                            ...
                            <div>
                                <x-cards.card-dashboard-version1-withshadow text="{{ json_encode([__('Workers Leaving the organisation, by gender')]) }}"
                                    ...
                                    @if ($report['leaving_organisation'] != null)
                                        <x-charts.donut id="leaving_organisation" class="m-auto !h-[180px] !w-[180px] print:!h-[120px] print:!w-[120px]" legendes="true"/>
                                    @else
                                        <p class="text-center pt-10 w-full">{{ __('Data not found!') }}</p>
                                    @endif
                                </x-cards.card-dashboard-version1-withshadow>
                        ...
                        <div class="">
                            <div class="border border-esg7/40 p-4 h-min rounded-md flex justify-between gap-4 justify-center w-5/12">
                                <div>
            ...
            <x-report.vertical.page title="{{ __('Social') }}" >
                <div class="">
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            <div class="border border-esg7/40 p-4 h-auto rounded-md flex justify-between gap-4 justify-center">
                                <div>
                                    <p class="text-base text-esg8 uppercase">{{ __('Average annual gross total remuneration including bonus money of all contracted workers (excluding the highest paid individual)') }}</p>
                            ...
                            <div class="border border-esg7/40 p-4 h-auto rounded-md flex justify-between gap-4 justify-center">
                                <div class="">
                                    <p class="text-base text-esg8 uppercase">{{ __('Days lost due to injury, accident, death or illness') }}</p>
                            ...
                            <div class="border border-esg7/40 p-4 h-auto rounded-md flex justify-between gap-4 justify-center">
                                <div class="">
                                    <p class="text-base text-esg8 uppercase">{{ __('Total gross annual remuneration including prize money of the highest paid individual') }}</p>
                                    <label for="checkbox-website" class="font-encodesans text-4xl font-bold text-esg1 mt-2">
                        ...
                        <div class="border border-esg7/40 p-4 h-auto rounded-md flex justify-between gap-4 justify-center">
                            <div class="">
                                <p class="text-base text-esg8 uppercase">{{ __('Accidents at work during the reporting period') }}</p>
                        ...
                        <div class="border border-esg7/40 p-4 h-auto rounded-md flex justify-between gap-4 justify-center">
                            <div class="">
                                <p class="text-base text-esg8 uppercase">{{ __('Gender pay gap') }}</p>
            ...
            <x-report.vertical.page title="{{ __('environment') }}" >
                <div class="py-5">
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <div class="">
                            <p class="text-base text-esg8 uppercase">{{ __('Practices in place to promote the safety and health of contracted workers') }}</p>
                        ...
                        <x-cards.card-dashboard-version1-withshadow text="{{ json_encode([__('Hours in training and capacity development')]) }}" class="!h-auto !shadow-none border border-esg7/40 w-6/12" contentplacement="none">
                            <div class="flex items-center justify-between w-full">
                                <div class="">
            ...
            {{-- Page 19 DONE--}}
            <x-report.vertical.pagewithimage url="/images/report/screen//vertical/6.png" header="true" border="border-b-esg3">
                <div class="">
                ...
                <div class="py-5">
                    <div class="grid grid-cols-1 gap-4">
                        <div>
                            ...
                            <x-report.table.table margin="!mt-2" class="!border-t-esg3">
                        ...
                        <div>
                            <p class="text-base text-esg16 uppercase mb-8">{{ __('Highest governance body of the organisation constituted and structured') }}</p>

                            @if ($no_executive_members)
                                <p class="text-xs text-esg8">{{__('Board of Directors with no Executive Members')}}</p>
                            @endif

                            @if ($with_executive_members)
                                <p class="text-xs text-esg8 mt-2">{{__('Board of Directors with Executive Members')}}</p>
                            @endif

                            @if ($mixed)
                                <p class="text-xs text-esg8 mt-2">{{__('Mixed')}}</p>
                            @endif

                            @if ($management_board)
                                <p class="text-xs text-esg8 mt-2">{{__('Management Board')}}</p>
                            @endif
                        </div>

                        <div class="">
                            <x-cards.card-dashboard-version1-withshadow text="{{ json_encode([__('Highest governance bo distribution by gender')]) }}" type="flex" contentplacement="none"
                                class="!h-auto !shadow-none border border-esg7/40 !w-6/12">
                                @if ($high_governance_body)
            ...
            <x-report.vertical.page title="{{ __('governance') }}">
                <div class="py-5">
                    <div class="grid grid-cols-1 gap-4">
                        <div class="">
                            <div class="">
                                <p class="text-base text-esg8 uppercase">{{ __('Initiatives undertaken by the organisation in regards to the community') }}</p>
                        ...
                        <div>
                            <p class="text-base font-bold uppercase text-esg8">{{ __('Significant Incidents') }}</p>
                            <x-report.table.table margin="!mt-2" class="!border-t-esg3">
                                <x-report.table.tr>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <x-cards.card-dashboard-version1-withshadow text="{{ json_encode([ __('Amount of the fines imposed') ]) }}" class="!h-auto !shadow-none border border-esg7/40" contentplacement="none">
                                <div class="flex items-center justify-between w-full">
                                    <div class="">
                            ...
                            <x-cards.card-dashboard-version1-withshadow text="{{ json_encode([ __('incidents of discrimination') ]) }}" class="!h-auto !shadow-none border border-esg7/40" contentplacement="none">
                                <div class="flex items-center justify-between w-full">
                                    <div class="">
            ...
            <x-report.vertical.page title="{{ __('governance') }}">
                <div class="py-5">
                    <div class="grid grid-cols-1 gap-4">
                        <div class="">
                            <div class="">
                                <p class="text-lg font-bold uppercase text-esg8">{{ __('Relations with suppliers') }}</p>
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        <div class="">
                            ...
                            @if ($logos['status'])
                                ...
                                <div class="grid grid-cols-4 items-center gap-12 py-8">
                                    @if ($logos['sbt'])
